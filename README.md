...
- I don't have a way to develop my own Neovim plug-ins in-place anymore (previously, I could just edit them in the submodules, test them, then commit).
...
On the bright side, cloning the repo now brings everything needed in a single step.
