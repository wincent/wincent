...
tell application "iTerm2"
    tell current session of current window
        ...
        set foreground color to {31354, 33153, 33153}

        -- Set ANSI Colors
        set ANSI black color to {257, 5654, 10023}
        set ANSI red color to {54227, 16962, 15934}
        set ANSI green color to {10794, 41634, 39064}
        set ANSI yellow color to {23644, 42919, 58596}
        ...
        set ANSI white color to {31354, 33153, 33153}

        -- Set Bright ANSI Colors
        set ANSI bright black color to {31354, 33153, 33153}
        ...
        set ANSI bright white color to {39064, 40863, 45489}
    end tell
end tell
