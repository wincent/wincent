-- Gruvbox Dark Medium (Forest) scheme by Muhammad Talha (muhammadtalha.quant@gmail.com), morhetz (https://github.com/morhetz/gruvbox)
--
...
vim.g.colors_name = "gruvbox-dark-medium-forest"
