...
if root then
  ...
  vim.opt.undodir = vim.fn.expand('~/.config/nvim/undo//') -- keep undo files out of the way
...
vim.opt.viewdir = vim.fn.expand('~/.config/nvim/view') -- where to store files for :mkview
