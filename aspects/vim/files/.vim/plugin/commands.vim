...
" Markdown previews.
command! -nargs=? -complete=file Glow call wincent#commands#glow(<q-args>)
command! -nargs=* -complete=file Marked call wincent#commands#marked(<q-args>)
command! -nargs=* -complete=file Preview call wincent#commands#preview(<q-args>)
