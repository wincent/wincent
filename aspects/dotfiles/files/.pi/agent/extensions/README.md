...
- Run a check from this directory with `bin/typecheck`. If the stubs are missing (fresh checkout, or you wiped them) it will call `bin/install-types` for you automatically before invoking `tsgo`.
