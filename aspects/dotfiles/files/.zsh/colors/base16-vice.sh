...
color07="81/81/81" # Base 05 - White
...
color_foreground="81/81/81" # Base 05
...
if [ -n "$ITERM_SESSION_ID" ]; then
  ...
  put_template_custom Pg 818181 # foreground
  put_template_custom Ph 181818 # background
  put_template_custom Pi 818181 # bold color
  put_template_custom Pj 323232 # selection color
  put_template_custom Pk 818181 # selected text color
  put_template_custom Pl 818181 # cursor
