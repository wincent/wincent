...
color07="4f/4b/51" # Base 06 - White
color08="c4/c3/c5" # Base 02 - Bright Black
color09="d8/13/7f" # Base 12 - Bright Red
color10="17/ad/98" # Base 14 - Bright Green
color11="dc/8a/0e" # Base 13 - Bright Yellow
color12="77/5d/ff" # Base 16 - Bright Blue
color13="aa/17/e6" # Base 17 - Bright Magenta
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_01_HEX="e1e1e2"
  export BASE24_COLOR_02_HEX="c4c3c5"
  export BASE24_COLOR_03_HEX="a7a5a8"
  export BASE24_COLOR_04_HEX="89878b"
  export BASE24_COLOR_05_HEX="6c696e"
  export BASE24_COLOR_06_HEX="4f4b51"
  export BASE24_COLOR_07_HEX="322d34"
  ...
  export BASE24_COLOR_0D_HEX="775dff"
  export BASE24_COLOR_0E_HEX="aa17e6"
  export BASE24_COLOR_0F_HEX="e013d0"
  ...
  export BASE24_COLOR_16_HEX="775dff"
  export BASE24_COLOR_17_HEX="aa17e6"
fi
