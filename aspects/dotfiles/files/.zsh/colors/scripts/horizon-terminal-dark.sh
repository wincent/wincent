...
color11="FA/C2/9A" # Base 13 - Bright Yellow
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_09_HEX="FAB795"
  export BASE24_COLOR_0A_HEX="FAC29A"
