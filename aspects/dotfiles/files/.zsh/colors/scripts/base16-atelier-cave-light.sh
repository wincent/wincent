...
color07="26/23/2a" # Base 06 - White
color08="8b/87/92" # Base 02 - Bright Black
color09="be/46/78" # Base 12 - Bright Red
color10="2a/92/92" # Base 14 - Bright Green
color11="a0/6e/3b" # Base 13 - Bright Yellow
color12="57/6d/db" # Base 16 - Bright Blue
color13="95/5a/e7" # Base 17 - Bright Magenta
color14="39/8b/c6" # Base 15 - Bright Cyan
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="efecf4"
  export BASE24_COLOR_01_HEX="e2dfe7"
  export BASE24_COLOR_02_HEX="8b8792"
  export BASE24_COLOR_03_HEX="7e7887"
  export BASE24_COLOR_04_HEX="655f6d"
  export BASE24_COLOR_05_HEX="585260"
  export BASE24_COLOR_06_HEX="26232a"
  export BASE24_COLOR_07_HEX="19171c"
  export BASE24_COLOR_08_HEX="be4678"
  export BASE24_COLOR_09_HEX="aa573c"
  export BASE24_COLOR_0A_HEX="a06e3b"
  export BASE24_COLOR_0B_HEX="2a9292"
  export BASE24_COLOR_0C_HEX="398bc6"
  export BASE24_COLOR_0D_HEX="576ddb"
  export BASE24_COLOR_0E_HEX="955ae7"
  export BASE24_COLOR_0F_HEX="bf40bf"
  export BASE24_COLOR_10_HEX="efecf4"
  export BASE24_COLOR_11_HEX="efecf4"
  export BASE24_COLOR_12_HEX="be4678"
  export BASE24_COLOR_13_HEX="a06e3b"
  export BASE24_COLOR_14_HEX="2a9292"
  export BASE24_COLOR_15_HEX="398bc6"
  export BASE24_COLOR_16_HEX="576ddb"
  export BASE24_COLOR_17_HEX="955ae7"
fi
