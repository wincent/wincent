...
color08="2c/31/3a" # Base 02 - Bright Black
color09="ef/59/6f" # Base 12 - Bright Red
color10="89/ca/78" # Base 14 - Bright Green
color11="e5/c0/7b" # Base 13 - Bright Yellow
color12="61/af/ef" # Base 16 - Bright Blue
color13="d5/5f/de" # Base 17 - Bright Magenta
color14="2b/ba/c5" # Base 15 - Bright Cyan
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_01_HEX="1c1f24"
  export BASE24_COLOR_02_HEX="2c313a"
  export BASE24_COLOR_03_HEX="434852"
  ...
  export BASE24_COLOR_08_HEX="ef596f"
  export BASE24_COLOR_09_HEX="d19a66"
  export BASE24_COLOR_0A_HEX="e5c07b"
  export BASE24_COLOR_0B_HEX="89ca78"
  export BASE24_COLOR_0C_HEX="2bbac5"
  export BASE24_COLOR_0D_HEX="61afef"
  export BASE24_COLOR_0E_HEX="d55fde"
  export BASE24_COLOR_0F_HEX="be5046"
  export BASE24_COLOR_10_HEX="000000"
  export BASE24_COLOR_11_HEX="000000"
  export BASE24_COLOR_12_HEX="ef596f"
  export BASE24_COLOR_13_HEX="e5c07b"
  export BASE24_COLOR_14_HEX="89ca78"
  export BASE24_COLOR_15_HEX="2bbac5"
  export BASE24_COLOR_16_HEX="61afef"
  export BASE24_COLOR_17_HEX="d55fde"
fi
