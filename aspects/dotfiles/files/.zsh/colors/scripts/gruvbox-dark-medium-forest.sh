...
export BASE24_THEME="gruvbox-dark-medium-forest"

color00="28/28/28" # Base 00 - Black
color01="fb/49/34" # Base 08 - Red
color02="b8/bb/26" # Base 0B - Green
color03="fa/bd/2f" # Base 0A - Yellow
color04="b8/bb/26" # Base 0D - Blue
color05="96/bd/a2" # Base 0E - Magenta
color06="5f/6c/1f" # Base 0C - Cyan
color07="d5/c4/a1" # Base 05 - White
color08="66/5c/50" # Base 03 - Bright Black
color09="fb/49/34" # Base 12 - Bright Red
color10="b8/bb/26" # Base 14 - Bright Green
color11="fa/bd/2f" # Base 13 - Bright Yellow
color12="b8/bb/26" # Base 16 - Bright Blue
color13="96/bd/a2" # Base 17 - Bright Magenta
color14="5f/6c/1f" # Base 15 - Bright Cyan
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_03_HEX="665c50"
  ...
  export BASE24_COLOR_0C_HEX="5f6c1f"
  export BASE24_COLOR_0D_HEX="b8bb26"
  export BASE24_COLOR_0E_HEX="96bda2"
  ...
  export BASE24_COLOR_15_HEX="5f6c1f"
  export BASE24_COLOR_16_HEX="b8bb26"
  export BASE24_COLOR_17_HEX="96bda2"
fi
