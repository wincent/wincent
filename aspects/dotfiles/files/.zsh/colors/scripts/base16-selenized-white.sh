...
color08="cd/cd/cd" # Base 02 - Bright Black
color09="bf/00/00" # Base 12 - Bright Red
color10="00/84/00" # Base 14 - Bright Green
color11="af/85/00" # Base 13 - Bright Yellow
color12="00/54/cf" # Base 16 - Bright Blue
color13="6b/40/c3" # Base 17 - Bright Magenta
color14="00/9a/8a" # Base 15 - Bright Cyan
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_01_HEX="ebebeb"
  export BASE24_COLOR_02_HEX="cdcdcd"
  export BASE24_COLOR_03_HEX="878787"
  export BASE24_COLOR_04_HEX="878787"
  export BASE24_COLOR_05_HEX="474747"
  export BASE24_COLOR_06_HEX="282828"
  export BASE24_COLOR_07_HEX="282828"
  export BASE24_COLOR_08_HEX="bf0000"
  export BASE24_COLOR_09_HEX="ba3700"
  export BASE24_COLOR_0A_HEX="af8500"
  export BASE24_COLOR_0B_HEX="008400"
  export BASE24_COLOR_0C_HEX="009a8a"
  export BASE24_COLOR_0D_HEX="0054cf"
  export BASE24_COLOR_0E_HEX="6b40c3"
  export BASE24_COLOR_0F_HEX="dd0f9d"
  export BASE24_COLOR_10_HEX="ffffff"
  export BASE24_COLOR_11_HEX="ffffff"
  export BASE24_COLOR_12_HEX="bf0000"
  export BASE24_COLOR_13_HEX="af8500"
  export BASE24_COLOR_14_HEX="008400"
  export BASE24_COLOR_15_HEX="009a8a"
  export BASE24_COLOR_16_HEX="0054cf"
  export BASE24_COLOR_17_HEX="6b40c3"
fi
