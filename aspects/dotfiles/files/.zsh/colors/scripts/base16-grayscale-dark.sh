...
color07="e3/e3/e3" # Base 06 - White
color08="46/46/46" # Base 02 - Bright Black
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_02_HEX="464646"
  export BASE24_COLOR_03_HEX="525252"
  export BASE24_COLOR_04_HEX="ababab"
  export BASE24_COLOR_05_HEX="b9b9b9"
  export BASE24_COLOR_06_HEX="e3e3e3"
