...
color10="33/ff/00" # Base 14 - Bright Green
color11="ff/00/99" # Base 13 - Bright Yellow
color12="00/66/ff" # Base 16 - Bright Blue
color13="cc/00/ff" # Base 17 - Bright Magenta
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_09_HEX="ff9900"
  export BASE24_COLOR_0A_HEX="ff0099"
  export BASE24_COLOR_0B_HEX="33ff00"
  export BASE24_COLOR_0C_HEX="00ffff"
  export BASE24_COLOR_0D_HEX="0066ff"
  export BASE24_COLOR_0E_HEX="cc00ff"
  export BASE24_COLOR_0F_HEX="3300ff"
  export BASE24_COLOR_10_HEX="000000"
  export BASE24_COLOR_11_HEX="000000"
  export BASE24_COLOR_12_HEX="ff0000"
  export BASE24_COLOR_13_HEX="ff0099"
  export BASE24_COLOR_14_HEX="33ff00"
  export BASE24_COLOR_15_HEX="00ffff"
  export BASE24_COLOR_16_HEX="0066ff"
  export BASE24_COLOR_17_HEX="cc00ff"
fi
