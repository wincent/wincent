...
color10="9b/8d/7f" # Base 14 - Bright Green
color11="8c/7f/70" # Base 13 - Bright Yellow
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_0A_HEX="8c7f70"
  export BASE24_COLOR_0B_HEX="9b8d7f"
  ...
  export BASE24_COLOR_13_HEX="8c7f70"
  export BASE24_COLOR_14_HEX="9b8d7f"
