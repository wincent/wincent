...
color07="c1/c1/c1" # Base 06 - White
color08="22/22/22" # Base 02 - Bright Black
color09="de/6e/6e" # Base 12 - Bright Red
color10="5f/87/87" # Base 14 - Bright Green
color11="ff/c7/99" # Base 13 - Bright Yellow
color12="8e/aa/aa" # Base 16 - Bright Blue
color13="d6/90/94" # Base 17 - Bright Magenta
color14="60/a5/92" # Base 15 - Bright Cyan
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_01_HEX="232323"
  export BASE24_COLOR_02_HEX="222222"
  export BASE24_COLOR_03_HEX="333333"
  export BASE24_COLOR_04_HEX="999999"
  export BASE24_COLOR_05_HEX="b7b7b7"
  export BASE24_COLOR_06_HEX="c1c1c1"
  export BASE24_COLOR_07_HEX="d5d5d5"
  export BASE24_COLOR_08_HEX="de6e6e"
  export BASE24_COLOR_09_HEX="dab083"
  export BASE24_COLOR_0A_HEX="ffc799"
  export BASE24_COLOR_0B_HEX="5f8787"
  export BASE24_COLOR_0C_HEX="60a592"
  export BASE24_COLOR_0D_HEX="8eaaaa"
  export BASE24_COLOR_0E_HEX="d69094"
  export BASE24_COLOR_0F_HEX="876c4f"
  export BASE24_COLOR_10_HEX="101010"
  export BASE24_COLOR_11_HEX="101010"
  export BASE24_COLOR_12_HEX="de6e6e"
  export BASE24_COLOR_13_HEX="ffc799"
  export BASE24_COLOR_14_HEX="5f8787"
  export BASE24_COLOR_15_HEX="60a592"
  export BASE24_COLOR_16_HEX="8eaaaa"
  export BASE24_COLOR_17_HEX="d69094"
fi
