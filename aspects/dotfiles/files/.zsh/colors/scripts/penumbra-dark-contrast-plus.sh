...
color07="FF/F7/ED" # Base 06 - White
color08="3E/40/44" # Base 02 - Bright Black
color09="DF/7F/78" # Base 12 - Bright Red
color10="50/B5/84" # Base 14 - Bright Green
color11="9C/A7/48" # Base 13 - Bright Yellow
color12="61/A3/E6" # Base 16 - Bright Blue
color13="A4/8F/E1" # Base 17 - Bright Magenta
color14="00/B3/C2" # Base 15 - Bright Cyan
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  export BASE24_COLOR_00_HEX="181B1F"
  export BASE24_COLOR_01_HEX="24272B"
  export BASE24_COLOR_02_HEX="3E4044"
  export BASE24_COLOR_03_HEX="636363"
  export BASE24_COLOR_04_HEX="9E9E9E"
  export BASE24_COLOR_05_HEX="CECECE"
  export BASE24_COLOR_06_HEX="FFF7ED"
  export BASE24_COLOR_07_HEX="FFFDFB"
  export BASE24_COLOR_08_HEX="DF7F78"
  export BASE24_COLOR_09_HEX="CE9042"
  export BASE24_COLOR_0A_HEX="9CA748"
  export BASE24_COLOR_0B_HEX="50B584"
  export BASE24_COLOR_0C_HEX="00B3C2"
  export BASE24_COLOR_0D_HEX="61A3E6"
  export BASE24_COLOR_0E_HEX="A48FE1"
  export BASE24_COLOR_0F_HEX="D080B6"
  export BASE24_COLOR_10_HEX="181B1F"
  export BASE24_COLOR_11_HEX="181B1F"
  export BASE24_COLOR_12_HEX="DF7F78"
  export BASE24_COLOR_13_HEX="9CA748"
  export BASE24_COLOR_14_HEX="50B584"
  export BASE24_COLOR_15_HEX="00B3C2"
  export BASE24_COLOR_16_HEX="61A3E6"
  export BASE24_COLOR_17_HEX="A48FE1"
fi
