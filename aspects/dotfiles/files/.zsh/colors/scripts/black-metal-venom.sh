...
color10="f8/f7/f2" # Base 14 - Bright Green
color11="79/24/1f" # Base 13 - Bright Yellow
...
if [ -n "$TINTED_SHELL_ENABLE_BASE24_VARS" ]; then
  ...
  export BASE24_COLOR_0A_HEX="79241f"
  export BASE24_COLOR_0B_HEX="f8f7f2"
  ...
  export BASE24_COLOR_13_HEX="79241f"
  export BASE24_COLOR_14_HEX="f8f7f2"
