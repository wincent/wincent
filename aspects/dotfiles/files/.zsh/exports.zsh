...
#
# Stop `git co prod` from triggering:
#
#     zsh: correct 'co' to 'ci' [yes, no, edit, abort]?
#
# in repos with a "ci" directory.
#
export CORRECT_IGNORE_FILE='.*|ci'
...
export FAVA_READ_ONLY=1

# See: https://cli.github.com/telemetry
export GH_TELEMETRY=false

# Avoid homedir clutter caused by GOPATH default of "$HOME/go".
...
# we're pretty much never on the latest release, and it is bothersome to be
# pestered by endless prompts to update at the start of every session. We just
