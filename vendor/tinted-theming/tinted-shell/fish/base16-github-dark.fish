...
set -U fish_pager_color_progress 161b22 --background=8b949e
set -U fish_pager_color_background --background=0d1117
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 79c0ff
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_08_HEX "ffa657"
  set -gx BASE16_COLOR_09_HEX "79c0ff"
  set -gx BASE16_COLOR_0A_HEX "bb8009"
  set -gx BASE16_COLOR_0B_HEX "a5d6ff"
  set -gx BASE16_COLOR_0C_HEX "7ee787"
  set -gx BASE16_COLOR_0D_HEX "d2a8ff"
  set -gx BASE16_COLOR_0E_HEX "ff7b72"
  set -gx BASE16_COLOR_0F_HEX "ffa198"
end
