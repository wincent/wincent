...
set -U fish_color_selection 404040 --background=d5d5d5
set -U fish_color_operator magenta
set -U fish_color_escape ffff00
...
set -U fish_color_search_match yellow --background=d5d5d5
...
set -U fish_pager_color_description ffff00
set -U fish_pager_color_selected_background --background=d5d5d5
set -U fish_pager_color_selected_prefix --bold --italics --background=d5d5d5
