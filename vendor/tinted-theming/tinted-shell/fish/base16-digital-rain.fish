...
set -U fish_color_selection c4cec4 --background=4a8d7e
set -U fish_color_operator magenta
set -U fish_color_escape c86428
...
set -U fish_color_search_match yellow --background=4a8d7e
...
set -U fish_pager_color_description c86428
set -U fish_pager_color_selected_background --background=4a8d7e
set -U fish_pager_color_selected_prefix --bold --italics --background=4a8d7e
