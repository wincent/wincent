...
# Set theme
set -Ux BASE16_THEME github-light-colorblind
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_07_HEX "24292f"
  set -gx BASE16_COLOR_08_HEX "8a4600"
  set -gx BASE16_COLOR_09_HEX "0550ae"
  set -gx BASE16_COLOR_0A_HEX "bf8700"
  set -gx BASE16_COLOR_0B_HEX "0a3069"
  set -gx BASE16_COLOR_0C_HEX "0550ae"
  set -gx BASE16_COLOR_0D_HEX "8250df"
  set -gx BASE16_COLOR_0E_HEX "b35900"
  set -gx BASE16_COLOR_0F_HEX "6f3800"
end
