...
set -U fish_color_selection bab696 --background=3a3527
set -U fish_color_operator magenta
set -U fish_color_escape fba11b
...
set -U fish_color_search_match yellow --background=3a3527
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2a261c --background=5f5b45
set -U fish_pager_color_background --background=1c1810
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fba11b
set -U fish_pager_color_selected_background --background=3a3527
set -U fish_pager_color_selected_prefix --bold --italics --background=3a3527
