...
set -l color09 "dd/7c/4c" # Base 12 - Bright Red
set -l color10 "cb/d8/8c" # Base 14 - Bright Green
set -l color11 "e1/c4/7d" # Base 13 - Bright Yellow
set -l color12 "5a/5d/61" # Base 16 - Bright Blue
set -l color13 "d0/db/8e" # Base 17 - Bright Magenta
set -l color14 "8a/98/9a" # Base 15 - Bright Cyan
