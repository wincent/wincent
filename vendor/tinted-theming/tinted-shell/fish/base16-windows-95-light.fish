...
set -U fish_color_selection 2a2a2a --background=c4c4c4
set -U fish_color_operator magenta
set -U fish_color_escape fcfc54
...
set -U fish_color_search_match yellow --background=c4c4c4
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e0e0e0 --background=7e7e7e
set -U fish_pager_color_background --background=fcfcfc
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fcfc54
set -U fish_pager_color_selected_background --background=c4c4c4
set -U fish_pager_color_selected_prefix --bold --italics --background=c4c4c4
