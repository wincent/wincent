...
set -U fish_color_selection ffeeff --background=331354
set -U fish_color_operator magenta
set -U fish_color_escape aa00a3
...
set -U fish_color_search_match yellow --background=331354
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1a092d --background=873582
set -U fish_pager_color_background --background=1e0528
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description aa00a3
set -U fish_pager_color_selected_background --background=331354
set -U fish_pager_color_selected_prefix --bold --italics --background=331354
