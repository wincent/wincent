...
set -U fish_color_selection ebe0bb --background=4d3f32
set -U fish_color_operator magenta
set -U fish_color_escape ebe0bb
...
set -U fish_color_search_match yellow --background=4d3f32
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 3a3124 --background=b8a58c
set -U fish_pager_color_background --background=242015
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ebe0bb
set -U fish_pager_color_selected_background --background=4d3f32
set -U fish_pager_color_selected_prefix --bold --italics --background=4d3f32
