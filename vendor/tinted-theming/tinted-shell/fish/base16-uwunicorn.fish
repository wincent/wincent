...
set -U fish_color_selection d9c2c6 --background=46354a
set -U fish_color_operator magenta
set -U fish_color_escape de5b44
...
set -U fish_color_search_match yellow --background=46354a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2f2a3f --background=7e5f83
set -U fish_pager_color_background --background=241b26
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description de5b44
set -U fish_pager_color_selected_background --background=46354a
set -U fish_pager_color_selected_prefix --bold --italics --background=46354a
