...
set -l color09 "ff/94/92" # Base 12 - Bright Red
set -l color10 "26/cd/4d" # Base 14 - Bright Green
set -l color11 "f0/b7/2f" # Base 13 - Bright Yellow
set -l color12 "71/b7/ff" # Base 16 - Bright Blue
set -l color13 "cb/9e/ff" # Base 17 - Bright Magenta
...
# Set theme
set -Ux BASE24_THEME github-dark-high-contrast

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE24_VARS"; or test -n "$BASE24_SHELL_ENABLE_VARS"
  set -gx BASE24_COLOR_00_HEX "0a0c10"
  set -gx BASE24_COLOR_01_HEX "272b33"
  set -gx BASE24_COLOR_02_HEX "7a828e"
  set -gx BASE24_COLOR_03_HEX "9ea7b3"
  set -gx BASE24_COLOR_04_HEX "bdc4cc"
  set -gx BASE24_COLOR_05_HEX "f0f3f6"
  set -gx BASE24_COLOR_06_HEX "ffffff"
  set -gx BASE24_COLOR_07_HEX "ffffff"
  set -gx BASE24_COLOR_08_HEX "ffb757"
  set -gx BASE24_COLOR_09_HEX "91cbff"
  set -gx BASE24_COLOR_0A_HEX "e09b13"
  set -gx BASE24_COLOR_0B_HEX "addcff"
  set -gx BASE24_COLOR_0C_HEX "72f088"
  set -gx BASE24_COLOR_0D_HEX "dbb7ff"
  set -gx BASE24_COLOR_0E_HEX "ff9492"
  set -gx BASE24_COLOR_0F_HEX "ffb1af"
end
