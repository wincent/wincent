...
set -U fish_color_selection fff7ed --background=3e4044
set -U fish_color_operator magenta
set -U fish_color_escape ba823a
...
set -U fish_pager_color_background --background=24272b
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ba823a
