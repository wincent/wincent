...
set -U fish_color_selection efefef --background=4d4d4c
set -U fish_color_operator magenta
set -U fish_color_escape f5871f
...
set -U fish_color_search_match yellow --background=4d4d4c
...
set -U fish_pager_color_description f5871f
set -U fish_pager_color_selected_background --background=4d4d4c
set -U fish_pager_color_selected_prefix --bold --italics --background=4d4d4c
