...
set -U fish_color_selection 786653 --background=c9b9a7
set -U fish_color_operator magenta
set -U fish_color_escape 64513e
...
set -U fish_color_search_match yellow --background=c9b9a7
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress ddcebc --background=a0907d
set -U fish_pager_color_background --background=f1e3d1
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 64513e
set -U fish_pager_color_selected_background --background=c9b9a7
set -U fish_pager_color_selected_prefix --bold --italics --background=c9b9a7
