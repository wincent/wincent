...
set -U fish_color_selection e3e3c8 --background=373c3d
set -U fish_color_operator magenta
set -U fish_color_escape e6db74
...
set -U fish_color_search_match yellow --background=373c3d
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 252c2d --background=818f80
set -U fish_pager_color_background --background=171e1f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e6db74
set -U fish_pager_color_selected_background --background=373c3d
set -U fish_pager_color_selected_prefix --bold --italics --background=373c3d
