...
set -l color09 "9d/00/06" # Base 12 - Bright Red
set -l color10 "79/74/0e" # Base 14 - Bright Green
set -l color11 "b5/76/14" # Base 13 - Bright Yellow
set -l color12 "07/66/78" # Base 16 - Bright Blue
set -l color13 "8f/3f/71" # Base 17 - Bright Magenta
set -l color14 "42/7b/58" # Base 15 - Bright Cyan
