...
set -U fish_color_selection e7e6df --background=5f5e4e
set -U fish_color_operator magenta
set -U fish_color_escape ae7313
...
set -U fish_color_search_match yellow --background=5f5e4e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 302f27 --background=878573
set -U fish_pager_color_background --background=22221b
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ae7313
set -U fish_pager_color_selected_background --background=5f5e4e
set -U fish_pager_color_selected_prefix --bold --italics --background=5f5e4e
