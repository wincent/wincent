...
set -U fish_color_selection 292424 --background=8a8585
...
set -U fish_color_search_match yellow --background=8a8585
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e7dfdf --background=655d5d
set -U fish_pager_color_background --background=f4ecec
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b45a3c
set -U fish_pager_color_selected_background --background=8a8585
set -U fish_pager_color_selected_prefix --bold --italics --background=8a8585
