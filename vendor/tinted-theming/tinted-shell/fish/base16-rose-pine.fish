...
set -U fish_color_selection e0def4 --background=26233a
set -U fish_color_operator magenta
set -U fish_color_escape f6c177
...
set -U fish_color_search_match yellow --background=26233a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1f1d2e --background=908caa
set -U fish_pager_color_background --background=191724
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f6c177
set -U fish_pager_color_selected_background --background=26233a
set -U fish_pager_color_selected_prefix --bold --italics --background=26233a
