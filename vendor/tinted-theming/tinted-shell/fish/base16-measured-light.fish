...
set -U fish_color_selection 181818 --background=ffeada
set -U fish_color_operator magenta
set -U fish_color_escape ad5601
...
set -U fish_color_search_match yellow --background=ffeada
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress f9f5f1 --background=404040
set -U fish_pager_color_background --background=fdf9f5
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ad5601
set -U fish_pager_color_selected_background --background=ffeada
set -U fish_pager_color_selected_prefix --bold --italics --background=ffeada
