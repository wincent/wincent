...
set -U fish_color_selection 292824 --background=a6a28c
...
set -U fish_color_search_match yellow --background=a6a28c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e8e4cf --background=7d7a68
set -U fish_pager_color_background --background=fefbec
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b65611
set -U fish_pager_color_selected_background --background=a6a28c
set -U fish_pager_color_selected_prefix --bold --italics --background=a6a28c
