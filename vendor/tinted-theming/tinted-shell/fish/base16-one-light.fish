...
set -U fish_color_selection 202227 --background=e5e5e6
set -U fish_color_operator magenta
set -U fish_color_escape d75f00
...
set -U fish_color_search_match yellow --background=e5e5e6
...
set -U fish_pager_color_description d75f00
set -U fish_pager_color_selected_background --background=e5e5e6
set -U fish_pager_color_selected_prefix --bold --italics --background=e5e5e6
