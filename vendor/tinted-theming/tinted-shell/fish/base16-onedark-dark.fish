...
set -U fish_color_selection b6bdca --background=2c313a
...
set -U fish_color_search_match yellow --background=2c313a
...
set -U fish_pager_color_selected_background --background=2c313a
set -U fish_pager_color_selected_prefix --bold --italics --background=2c313a
