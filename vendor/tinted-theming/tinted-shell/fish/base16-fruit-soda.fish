...
set -U fish_color_selection 474545 --background=d8d5d5
set -U fish_color_operator magenta
set -U fish_color_escape fe6d08
...
set -U fish_color_search_match yellow --background=d8d5d5
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e0dee0 --background=979598
set -U fish_pager_color_background --background=f1ecf1
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fe6d08
set -U fish_pager_color_selected_background --background=d8d5d5
set -U fish_pager_color_selected_prefix --bold --italics --background=d8d5d5
