...
set -U fish_color_selection 525252 --background=9e9e9e
...
set -U fish_color_search_match yellow --background=9e9e9e
...
set -U fish_pager_color_selected_background --background=9e9e9e
set -U fish_pager_color_selected_prefix --bold --italics --background=9e9e9e
