...
set -U fish_color_selection 252525 --background=b9b9b9
...
set -U fish_color_search_match yellow --background=b9b9b9
...
set -U fish_pager_color_selected_background --background=b9b9b9
set -U fish_pager_color_selected_prefix --bold --italics --background=b9b9b9
