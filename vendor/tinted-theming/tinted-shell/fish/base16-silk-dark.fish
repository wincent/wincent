...
set -U fish_color_selection cbf2f7 --background=2a5054
set -U fish_color_operator magenta
set -U fish_color_escape fcab74
...
set -U fish_color_search_match yellow --background=2a5054
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1d494e --background=9dc8cd
set -U fish_pager_color_background --background=0e3c46
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fcab74
set -U fish_pager_color_selected_background --background=2a5054
set -U fish_pager_color_selected_prefix --bold --italics --background=2a5054
