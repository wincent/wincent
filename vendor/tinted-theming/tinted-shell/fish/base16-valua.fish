...
set -U fish_color_selection a5cbb9 --background=273d3c
set -U fish_color_operator magenta
set -U fish_color_escape e6b466
...
set -U fish_color_search_match yellow --background=273d3c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 213132 --background=6d9877
set -U fish_pager_color_background --background=131f1f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e6b466
set -U fish_pager_color_selected_background --background=273d3c
set -U fish_pager_color_selected_prefix --bold --italics --background=273d3c
