...
set -U fish_color_selection 899ba6 --background=6a7d89
set -U fish_color_operator magenta
set -U fish_color_escape 7fc1ca
...
set -U fish_color_search_match yellow --background=6a7d89
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 556873 --background=899ba6
set -U fish_pager_color_background --background=3c4c55
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 7fc1ca
set -U fish_pager_color_selected_background --background=6a7d89
set -U fish_pager_color_selected_prefix --bold --italics --background=6a7d89
