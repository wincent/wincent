...
set -U fish_color_selection 2f3337 --background=deded8
set -U fish_color_operator magenta
set -U fish_color_escape ff3d00
...
set -U fish_color_search_match yellow --background=deded8
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress efefe9 --background=60615d
set -U fish_pager_color_background --background=f8f8f2
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff3d00
set -U fish_pager_color_selected_background --background=deded8
set -U fish_pager_color_selected_prefix --bold --italics --background=deded8
