...
set -U fish_color_selection cfe8cf --background=5e6e5e
set -U fish_color_operator magenta
set -U fish_color_escape 87711d
...
set -U fish_color_search_match yellow --background=5e6e5e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 242924 --background=809980
set -U fish_pager_color_background --background=131513
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 87711d
set -U fish_pager_color_selected_background --background=5e6e5e
set -U fish_pager_color_selected_prefix --bold --italics --background=5e6e5e
