...
set -l color09 "ff/66/40" # Base 12 - Bright Red
set -l color10 "61/ee/56" # Base 14 - Bright Green
set -l color11 "f2/f0/55" # Base 13 - Bright Yellow
set -l color12 "00/81/ff" # Base 16 - Bright Blue
set -l color13 "ff/7d/fe" # Base 17 - Bright Magenta
set -l color14 "60/f6/f8" # Base 15 - Bright Cyan
