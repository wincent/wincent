...
set -U fish_color_selection efefef --background=005453
set -U fish_color_operator magenta
set -U fish_color_escape dca37c
...
set -U fish_color_search_match yellow --background=005453
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 003a38 --background=c3c3c3
set -U fish_pager_color_background --background=00211f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description dca37c
set -U fish_pager_color_selected_background --background=005453
set -U fish_pager_color_selected_prefix --bold --italics --background=005453
