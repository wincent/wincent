...
set -U fish_color_selection 292329 --background=ab9bab
...
set -U fish_color_search_match yellow --background=ab9bab
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress d8cad8 --background=776977
set -U fish_pager_color_background --background=f7f3f7
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a65926
set -U fish_pager_color_selected_background --background=ab9bab
set -U fish_pager_color_selected_prefix --bold --italics --background=ab9bab
