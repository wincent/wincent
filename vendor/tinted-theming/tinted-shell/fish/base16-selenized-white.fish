...
set -U fish_color_selection 282828 --background=cdcdcd
set -U fish_color_operator magenta
set -U fish_color_escape ba3700
...
set -U fish_color_search_match yellow --background=cdcdcd
...
set -U fish_pager_color_description ba3700
set -U fish_pager_color_selected_background --background=cdcdcd
set -U fish_pager_color_selected_prefix --bold --italics --background=cdcdcd
