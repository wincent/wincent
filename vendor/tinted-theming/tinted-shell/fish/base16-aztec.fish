...
set -U fish_color_selection ffe178 --background=242604
set -U fish_color_operator magenta
set -U fish_color_escape ee8800
...
set -U fish_color_search_match yellow --background=242604
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1a1e01 --background=ffd129
set -U fish_pager_color_background --background=101600
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ee8800
set -U fish_pager_color_selected_background --background=242604
set -U fish_pager_color_selected_prefix --bold --italics --background=242604
