...
set -U fish_color_selection ecf6f2 --background=5a605d
set -U fish_color_operator magenta
set -U fish_color_escape b38a61
...
set -U fish_color_search_match yellow --background=5a605d
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 434846 --background=cad8d2
set -U fish_pager_color_background --background=2d302f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b38a61
set -U fish_pager_color_selected_background --background=5a605d
set -U fish_pager_color_selected_prefix --bold --italics --background=5a605d
