...
set -l color09 "ff/27/3f" # Base 12 - Bright Red
set -l color10 "ab/e0/5a" # Base 14 - Bright Green
set -l color11 "ff/d1/41" # Base 13 - Bright Yellow
set -l color12 "00/92/ff" # Base 16 - Bright Blue
set -l color13 "9a/5f/eb" # Base 17 - Bright Magenta
set -l color14 "67/ff/ef" # Base 15 - Bright Cyan
