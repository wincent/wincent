...
set -U fish_color_selection a7cfa3 --background=2a343a
set -U fish_color_operator magenta
set -U fish_color_escape 43820d
...
set -U fish_color_search_match yellow --background=2a343a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1c3657 --background=84898c
set -U fish_pager_color_background --background=232c31
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 43820d
set -U fish_pager_color_selected_background --background=2a343a
set -U fish_pager_color_selected_prefix --bold --italics --background=2a343a
