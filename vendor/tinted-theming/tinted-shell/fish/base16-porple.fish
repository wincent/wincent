...
set -U fish_color_selection e8e8e8 --background=474160
set -U fish_color_operator magenta
set -U fish_color_escape d28e5d
...
set -U fish_color_search_match yellow --background=474160
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 333344 --background=b8b8b8
set -U fish_pager_color_background --background=292c36
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d28e5d
set -U fish_pager_color_selected_background --background=474160
set -U fish_pager_color_selected_prefix --bold --italics --background=474160
