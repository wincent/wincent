...
set -U fish_color_selection 42383a --background=e0ccd1
set -U fish_color_operator magenta
set -U fish_color_escape f6661e
...
set -U fish_color_search_match yellow --background=e0ccd1
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress f8e2e7 --background=665055
set -U fish_pager_color_background --background=feedf3
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f6661e
set -U fish_pager_color_selected_background --background=e0ccd1
set -U fish_pager_color_selected_prefix --bold --italics --background=e0ccd1
