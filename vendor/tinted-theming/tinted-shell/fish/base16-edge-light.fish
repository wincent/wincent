...
set -U fish_color_selection 3a3a46 --background=acb1b9
...
set -U fish_color_search_match yellow --background=acb1b9
...
set -U fish_pager_color_selected_background --background=acb1b9
set -U fish_pager_color_selected_prefix --bold --italics --background=acb1b9
