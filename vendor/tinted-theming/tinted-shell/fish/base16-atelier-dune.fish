...
set -U fish_color_selection e8e4cf --background=6e6b5e
set -U fish_color_operator magenta
set -U fish_color_escape b65611
...
set -U fish_color_search_match yellow --background=6e6b5e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 292824 --background=999580
set -U fish_pager_color_background --background=20201d
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b65611
set -U fish_pager_color_selected_background --background=6e6b5e
set -U fish_pager_color_selected_prefix --bold --italics --background=6e6b5e
