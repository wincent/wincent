...
set -U fish_color_selection 91ccff --background=273e5c
set -U fish_color_operator magenta
set -U fish_color_escape ff8080
...
set -U fish_color_search_match yellow --background=273e5c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1e5c1e --background=1e5c1e
set -U fish_pager_color_background --background=141f2e
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff8080
set -U fish_pager_color_selected_background --background=273e5c
set -U fish_pager_color_selected_prefix --bold --italics --background=273e5c
