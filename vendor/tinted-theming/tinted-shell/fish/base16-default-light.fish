...
set -U fish_color_selection 282828 --background=d8d8d8
set -U fish_color_operator magenta
set -U fish_color_escape dc9656
...
set -U fish_color_search_match yellow --background=d8d8d8
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e8e8e8 --background=585858
set -U fish_pager_color_background --background=f8f8f8
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description dc9656
set -U fish_pager_color_selected_background --background=d8d8d8
set -U fish_pager_color_selected_prefix --bold --italics --background=d8d8d8
