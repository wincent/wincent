...
set -U fish_color_selection 2c2421 --background=a8a19f
set -U fish_color_operator magenta
set -U fish_color_escape df5320
...
set -U fish_color_search_match yellow --background=a8a19f
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e6e2e0 --background=766e6b
set -U fish_pager_color_background --background=f1efee
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description df5320
set -U fish_pager_color_selected_background --background=a8a19f
set -U fish_pager_color_selected_prefix --bold --italics --background=a8a19f
