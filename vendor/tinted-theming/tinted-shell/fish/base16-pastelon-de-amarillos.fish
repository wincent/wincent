...
set -l color01 "bd/35/48" # Base 08 - Red
set -l color02 "16/74/51" # Base 0B - Green
set -l color03 "94/64/00" # Base 0A - Yellow
set -l color04 "1e/5d/a8" # Base 0D - Blue
set -l color05 "8d/3f/89" # Base 0E - Magenta
set -l color06 "00/72/70" # Base 0C - Cyan
...
set -l color16 "ad/57/0f" # Base 09
set -l color17 "7c/35/28" # Base 0F
...
set -U fish_color_escape ad570f
...
set -U fish_pager_color_description ad570f
...
# Set theme
set -Ux BASE16_THEME pastelon-de-amarillos

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fff4d6"
  set -gx BASE16_COLOR_01_HEX "f2d083"
  set -gx BASE16_COLOR_02_HEX "d69b45"
  set -gx BASE16_COLOR_03_HEX "80616b"
  set -gx BASE16_COLOR_04_HEX "684653"
  set -gx BASE16_COLOR_05_HEX "432c3b"
  set -gx BASE16_COLOR_06_HEX "2f1c2e"
  set -gx BASE16_COLOR_07_HEX "1c0f20"
  set -gx BASE16_COLOR_08_HEX "bd3548"
  set -gx BASE16_COLOR_09_HEX "ad570f"
  set -gx BASE16_COLOR_0A_HEX "946400"
  set -gx BASE16_COLOR_0B_HEX "167451"
  set -gx BASE16_COLOR_0C_HEX "007270"
  set -gx BASE16_COLOR_0D_HEX "1e5da8"
  set -gx BASE16_COLOR_0E_HEX "8d3f89"
  set -gx BASE16_COLOR_0F_HEX "7c3528"
end
