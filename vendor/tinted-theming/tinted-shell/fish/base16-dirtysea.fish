...
set -U fish_color_selection f8f8f8 --background=d0d0d0
set -U fish_color_operator magenta
set -U fish_color_escape 006565
...
set -U fish_pager_color_background --background=e0e0e0
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 006565
