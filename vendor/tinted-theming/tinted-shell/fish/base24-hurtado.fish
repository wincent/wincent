...
set -l color09 "d4/1c/00" # Base 12 - Bright Red
set -l color10 "a5/df/55" # Base 14 - Bright Green
set -l color11 "fb/e7/49" # Base 13 - Bright Yellow
set -l color12 "89/bd/ff" # Base 16 - Bright Blue
set -l color13 "bf/00/c0" # Base 17 - Bright Magenta
set -l color14 "85/e9/fe" # Base 15 - Bright Cyan
