...
set -U fish_color_selection d6d7d9 --background=4b6988
set -U fish_color_operator magenta
set -U fish_color_escape ff9966
...
set -U fish_color_search_match yellow --background=4b6988
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 3d566f --background=7e90a3
set -U fish_pager_color_background --background=2a3b4d
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9966
set -U fish_pager_color_selected_background --background=4b6988
set -U fish_pager_color_selected_prefix --bold --italics --background=4b6988
