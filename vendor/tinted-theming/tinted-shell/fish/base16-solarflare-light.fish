...
set -U fish_color_selection 222e38 --background=a6afb8
set -U fish_color_operator magenta
set -U fish_color_escape e66b2b
...
set -U fish_color_search_match yellow --background=a6afb8
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e8e9ed --background=667581
set -U fish_pager_color_background --background=f5f7fa
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e66b2b
set -U fish_pager_color_selected_background --background=a6afb8
set -U fish_pager_color_selected_prefix --bold --italics --background=a6afb8
