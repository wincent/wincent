...
set -U fish_color_selection f8eae7 --background=0f181e
set -U fish_color_operator magenta
set -U fish_color_escape fbcbae
...
set -U fish_color_search_match yellow --background=0f181e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 0a1014 --background=192630
set -U fish_pager_color_background --background=05080a
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fbcbae
set -U fish_pager_color_selected_background --background=0f181e
set -U fish_pager_color_selected_prefix --bold --italics --background=0f181e
