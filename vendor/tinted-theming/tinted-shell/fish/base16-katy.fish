...
set -U fish_color_selection 959dcb --background=5c598b
set -U fish_color_operator magenta
set -U fish_color_escape f78c6c
...
set -U fish_color_search_match yellow --background=5c598b
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 444267 --background=8796b0
set -U fish_pager_color_background --background=292d3e
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f78c6c
set -U fish_pager_color_selected_background --background=5c598b
set -U fish_pager_color_selected_prefix --bold --italics --background=5c598b
