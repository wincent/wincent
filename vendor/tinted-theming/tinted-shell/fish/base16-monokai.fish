...
set -U fish_color_selection f5f4f1 --background=49483e
set -U fish_color_operator magenta
set -U fish_color_escape fd971f
...
set -U fish_color_search_match yellow --background=49483e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 383830 --background=a59f85
set -U fish_pager_color_background --background=272822
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fd971f
set -U fish_pager_color_selected_background --background=49483e
set -U fish_pager_color_selected_prefix --bold --italics --background=49483e
