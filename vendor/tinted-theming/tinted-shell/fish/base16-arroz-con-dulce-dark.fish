...
set -l color00 "21/14/0f" # Base 00 - Black
set -l color01 "e0/7a/8a" # Base 08 - Red
set -l color02 "d4/7a/50" # Base 0B - Green
set -l color03 "d9/a4/41" # Base 0A - Yellow
set -l color04 "b9/9a/c8" # Base 0D - Blue
set -l color05 "d5/8a/b4" # Base 0E - Magenta
set -l color06 "d9/82/76" # Base 0C - Cyan
set -l color07 "f2/df/c0" # Base 05 - White
set -l color08 "a9/85/68" # Base 03 - Bright Black
...
set -l color15 "ff/f8/e7" # Base 07 - Bright White
set -l color16 "e6/8a/4a" # Base 09
set -l color17 "b9/77/55" # Base 0F
set -l color18 "2c/1a/13" # Base 01
set -l color19 "3b/24/1a" # Base 02
set -l color20 "c8/a7/7a" # Base 04
set -l color21 "f8/eb/d3" # Base 06
set -l color_foreground "f2/df/c0" # Base 05
set -l color_background "21/14/0f" # Base 00
...
set -U fish_color_comment a98568
set -U fish_color_selection f8ebd3 --background=3b241a
set -U fish_color_operator magenta
set -U fish_color_escape e68a4a
set -U fish_color_autosuggestion a98568
...
set -U fish_color_search_match yellow --background=3b241a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2c1a13 --background=c8a77a
set -U fish_pager_color_background --background=21140f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e68a4a
set -U fish_pager_color_selected_background --background=3b241a
set -U fish_pager_color_selected_prefix --bold --italics --background=3b241a
...
# Set theme
set -Ux BASE16_THEME arroz-con-dulce-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "21140f"
  set -gx BASE16_COLOR_01_HEX "2c1a13"
  set -gx BASE16_COLOR_02_HEX "3b241a"
  set -gx BASE16_COLOR_03_HEX "a98568"
  set -gx BASE16_COLOR_04_HEX "c8a77a"
  set -gx BASE16_COLOR_05_HEX "f2dfc0"
  set -gx BASE16_COLOR_06_HEX "f8ebd3"
  set -gx BASE16_COLOR_07_HEX "fff8e7"
  set -gx BASE16_COLOR_08_HEX "e07a8a"
  set -gx BASE16_COLOR_09_HEX "e68a4a"
  set -gx BASE16_COLOR_0A_HEX "d9a441"
  set -gx BASE16_COLOR_0B_HEX "d47a50"
  set -gx BASE16_COLOR_0C_HEX "d98276"
  set -gx BASE16_COLOR_0D_HEX "b99ac8"
  set -gx BASE16_COLOR_0E_HEX "d58ab4"
  set -gx BASE16_COLOR_0F_HEX "b97755"
end
