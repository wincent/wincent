...
# Set theme
set -Ux BASE16_THEME cerulean-signal-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "101722"
  set -gx BASE16_COLOR_01_HEX "131c29"
  set -gx BASE16_COLOR_02_HEX "173a5a"
  set -gx BASE16_COLOR_03_HEX "8fa0b5"
  set -gx BASE16_COLOR_04_HEX "aab8ca"
  set -gx BASE16_COLOR_05_HEX "dce6f2"
  set -gx BASE16_COLOR_06_HEX "f1f6fc"
  set -gx BASE16_COLOR_07_HEX "f7f9fc"
  set -gx BASE16_COLOR_08_HEX "ff8a9a"
  set -gx BASE16_COLOR_09_HEX "f5a35c"
  set -gx BASE16_COLOR_0A_HEX "e2c85f"
  set -gx BASE16_COLOR_0B_HEX "70e1b0"
  set -gx BASE16_COLOR_0C_HEX "58d9df"
  set -gx BASE16_COLOR_0D_HEX "7dd3ff"
  set -gx BASE16_COLOR_0E_HEX "ff74d4"
  set -gx BASE16_COLOR_0F_HEX "d59b7d"
end
