...
set -U fish_color_selection ebdbb2 --background=5a524c
...
set -U fish_color_search_match yellow --background=5a524c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 3c3836 --background=bdae93
set -U fish_pager_color_background --background=32302f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e78a4e
set -U fish_pager_color_selected_background --background=5a524c
set -U fish_pager_color_selected_prefix --bold --italics --background=5a524c
