...
set -U fish_color_selection 3a4d53 --background=d5cdb6
set -U fish_color_operator magenta
set -U fish_color_escape bc5819
...
set -U fish_color_search_match yellow --background=d5cdb6
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress ece3cc --background=909995
set -U fish_pager_color_background --background=fbf3db
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bc5819
set -U fish_pager_color_selected_background --background=d5cdb6
set -U fish_pager_color_selected_prefix --bold --italics --background=d5cdb6
