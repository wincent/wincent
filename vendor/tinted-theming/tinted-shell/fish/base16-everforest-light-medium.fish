...
set -U fish_color_selection 475258 --background=e6e2cc
...
set -U fish_color_search_match yellow --background=e6e2cc
...
set -U fish_pager_color_selected_background --background=e6e2cc
set -U fish_pager_color_selected_prefix --bold --italics --background=e6e2cc
