...
set -U fish_color_selection 6e6459 --background=d5d2cb
set -U fish_color_operator magenta
set -U fish_color_escape 8f5d22
...
set -U fish_color_search_match yellow --background=d5d2cb
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e8e7e3 --background=746c62
set -U fish_pager_color_background --background=f5f4f0
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 8f5d22
set -U fish_pager_color_selected_background --background=d5d2cb
set -U fish_pager_color_selected_prefix --bold --italics --background=d5d2cb
