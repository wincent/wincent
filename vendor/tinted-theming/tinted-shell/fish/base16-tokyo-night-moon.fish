...
set -U fish_color_selection aeb4d1 --background=2d3f76
...
set -U fish_color_search_match yellow --background=2d3f76
...
set -U fish_pager_color_selected_background --background=2d3f76
set -U fish_pager_color_selected_prefix --bold --italics --background=2d3f76
