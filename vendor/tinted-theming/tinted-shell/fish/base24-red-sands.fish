...
set -l color09 "bb/00/00" # Base 12 - Bright Red
set -l color10 "00/bb/00" # Base 14 - Bright Green
set -l color11 "e7/b0/00" # Base 13 - Bright Yellow
set -l color12 "00/71/ae" # Base 16 - Bright Blue
