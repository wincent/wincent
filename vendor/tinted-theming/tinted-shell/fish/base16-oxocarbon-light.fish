...
set -U fish_color_selection 3d4652 --background=bec6cf
set -U fish_color_operator magenta
set -U fish_color_escape ee5396
...
set -U fish_color_search_match yellow --background=bec6cf
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress dde1e6 --background=68788d
set -U fish_pager_color_background --background=f2f4f8
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ee5396
set -U fish_pager_color_selected_background --background=bec6cf
set -U fish_pager_color_selected_prefix --bold --italics --background=bec6cf
