...
set -U fish_color_selection 0e3c46 --background=90b7b6
set -U fish_color_operator magenta
set -U fish_color_escape d27f46
...
set -U fish_color_search_match yellow --background=90b7b6
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress ccd4d3 --background=4b5b5f
set -U fish_pager_color_background --background=e9f1ef
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d27f46
set -U fish_pager_color_selected_background --background=90b7b6
set -U fish_pager_color_selected_prefix --bold --italics --background=90b7b6
