...
set -U fish_color_selection edeaef --background=3e2d5c
set -U fish_color_operator magenta
set -U fish_color_escape 918889
...
set -U fish_color_search_match yellow --background=3e2d5c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 100323 --background=bebcbf
set -U fish_pager_color_background --background=271c3a
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 918889
set -U fish_pager_color_selected_background --background=3e2d5c
set -U fish_pager_color_selected_prefix --bold --italics --background=3e2d5c
