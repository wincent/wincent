...
set -U fish_color_selection 9e9e9e --background=323639
set -U fish_color_operator magenta
set -U fish_color_escape ff9800
...
set -U fish_color_search_match yellow --background=323639
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 27292c --background=676c71
set -U fish_pager_color_background --background=202124
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9800
set -U fish_pager_color_selected_background --background=323639
set -U fish_pager_color_selected_prefix --bold --italics --background=323639
