...
set -U fish_color_selection cdd3de --background=4f5b66
set -U fish_color_operator magenta
set -U fish_color_escape f99157
...
set -U fish_color_search_match yellow --background=4f5b66
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 343d46 --background=a7adba
set -U fish_pager_color_background --background=1b2b34
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f99157
set -U fish_pager_color_selected_background --background=4f5b66
set -U fish_pager_color_selected_prefix --bold --italics --background=4f5b66
