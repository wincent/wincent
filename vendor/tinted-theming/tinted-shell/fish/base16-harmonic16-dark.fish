...
set -U fish_color_selection e5ebf1 --background=405c79
set -U fish_color_operator magenta
set -U fish_color_escape bfbf56
...
set -U fish_color_search_match yellow --background=405c79
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 223b54 --background=aabcce
set -U fish_pager_color_background --background=0b1c2c
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bfbf56
set -U fish_pager_color_selected_background --background=405c79
set -U fish_pager_color_selected_prefix --bold --italics --background=405c79
