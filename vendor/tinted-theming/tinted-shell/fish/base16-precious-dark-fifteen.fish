...
set -U fish_color_selection bab9b6 --background=3e4044
set -U fish_color_operator magenta
set -U fish_color_escape e99857
...
set -U fish_color_search_match yellow --background=3e4044
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 303337 --background=abaaa8
set -U fish_pager_color_background --background=23262b
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e99857
set -U fish_pager_color_selected_background --background=3e4044
set -U fish_pager_color_selected_prefix --bold --italics --background=3e4044
