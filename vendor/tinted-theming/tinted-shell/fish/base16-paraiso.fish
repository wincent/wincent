...
set -U fish_color_selection b9b6b0 --background=4f424c
set -U fish_color_operator magenta
set -U fish_color_escape f99b15
...
set -U fish_color_search_match yellow --background=4f424c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 41323f --background=8d8687
set -U fish_pager_color_background --background=2f1e2e
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f99b15
set -U fish_pager_color_selected_background --background=4f424c
set -U fish_pager_color_selected_prefix --bold --italics --background=4f424c
