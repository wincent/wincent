...
set -U fish_color_selection e0e0ff --background=30305a
set -U fish_color_operator magenta
set -U fish_color_escape fc8d28
...
set -U fish_color_search_match yellow --background=30305a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 20204a --background=b0b0da
set -U fish_pager_color_background --background=00002a
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fc8d28
set -U fish_pager_color_selected_background --background=30305a
set -U fish_pager_color_selected_prefix --bold --italics --background=30305a
