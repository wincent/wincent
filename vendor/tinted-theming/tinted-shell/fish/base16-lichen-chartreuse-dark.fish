...
# Set theme
set -Ux BASE16_THEME lichen-chartreuse-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "151613"
  set -gx BASE16_COLOR_01_HEX "1c1e1a"
  set -gx BASE16_COLOR_02_HEX "3e5123"
  set -gx BASE16_COLOR_03_HEX "899282"
  set -gx BASE16_COLOR_04_HEX "a0a598"
  set -gx BASE16_COLOR_05_HEX "e0e5da"
  set -gx BASE16_COLOR_06_HEX "ecefe7"
  set -gx BASE16_COLOR_07_HEX "fcfcfa"
  set -gx BASE16_COLOR_08_HEX "e28b82"
  set -gx BASE16_COLOR_09_HEX "d5ad73"
  set -gx BASE16_COLOR_0A_HEX "b2d084"
  set -gx BASE16_COLOR_0B_HEX "83bda5"
  set -gx BASE16_COLOR_0C_HEX "9cc6c9"
  set -gx BASE16_COLOR_0D_HEX "78adc4"
  set -gx BASE16_COLOR_0E_HEX "bfa6d4"
  set -gx BASE16_COLOR_0F_HEX "d2a0b2"
end
