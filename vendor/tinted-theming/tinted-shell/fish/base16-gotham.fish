...
set -U fish_color_selection 99d1ce --background=091f2e
set -U fish_color_operator magenta
set -U fish_color_escape d26937
...
set -U fish_color_search_match yellow --background=091f2e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 11151c --background=245361
set -U fish_pager_color_background --background=0c1014
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d26937
set -U fish_pager_color_selected_background --background=091f2e
set -U fish_pager_color_selected_prefix --bold --italics --background=091f2e
