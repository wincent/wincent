...
set -U fish_color_selection e4e4e4 --background=4e4e4e
...
set -U fish_color_search_match yellow --background=4e4e4e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1c1c1c --background=e4e4e4
set -U fish_pager_color_background --background=232323
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a64270
set -U fish_pager_color_selected_background --background=4e4e4e
set -U fish_pager_color_selected_prefix --bold --italics --background=4e4e4e
