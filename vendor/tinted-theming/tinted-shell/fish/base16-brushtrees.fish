...
set -U fish_color_selection 5a6d7a --background=b0c5c8
set -U fish_color_operator magenta
set -U fish_color_escape d8bba2
...
set -U fish_color_search_match yellow --background=b0c5c8
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress c9dbdc --background=8299a1
set -U fish_pager_color_background --background=e3efef
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d8bba2
set -U fish_pager_color_selected_background --background=b0c5c8
set -U fish_pager_color_selected_prefix --bold --italics --background=b0c5c8
