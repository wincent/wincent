...
set -U fish_color_selection dedede --background=3b3b3b
set -U fish_color_operator magenta
set -U fish_color_escape e67f43
...
set -U fish_color_search_match yellow --background=3b3b3b
...
set -U fish_pager_color_description e67f43
set -U fish_pager_color_selected_background --background=3b3b3b
set -U fish_pager_color_selected_prefix --bold --italics --background=3b3b3b
