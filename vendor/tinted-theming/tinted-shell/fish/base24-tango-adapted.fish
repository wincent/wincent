...
set -l color10 "93/fe/00" # Base 14 - Bright Green
set -l color11 "ff/f0/21" # Base 13 - Bright Yellow
set -l color12 "88/c9/ff" # Base 16 - Bright Blue
set -l color13 "e8/a6/e1" # Base 17 - Bright Magenta
set -l color14 "00/fd/ff" # Base 15 - Bright Cyan
