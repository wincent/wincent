...
set -U fish_color_selection dbdde0 --background=4d5666
set -U fish_color_operator magenta
set -U fish_color_escape f0a000
...
set -U fish_color_search_match yellow --background=4d5666
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2a3448 --background=9a99a3
set -U fish_pager_color_background --background=061229
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f0a000
set -U fish_pager_color_selected_background --background=4d5666
set -U fish_pager_color_selected_prefix --bold --italics --background=4d5666
