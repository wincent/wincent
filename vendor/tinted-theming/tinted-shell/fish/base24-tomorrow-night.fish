...
set -l color09 "e7/4c/3c" # Base 12 - Bright Red
set -l color10 "b8/d4/b3" # Base 14 - Bright Green
set -l color11 "f7/dc/6f" # Base 13 - Bright Yellow
set -l color12 "85/c1/e9" # Base 16 - Bright Blue
set -l color13 "d7/a3/ca" # Base 17 - Bright Magenta
set -l color14 "95/d3/ce" # Base 15 - Bright Cyan
