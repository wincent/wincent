...
set -U fish_color_selection fff2d1 --background=2a2a3f
set -U fish_color_operator magenta
set -U fish_color_escape ff773a
...
set -U fish_color_search_match yellow --background=2a2a3f
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 202030 --background=515155
set -U fish_pager_color_background --background=1a1a2f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff773a
set -U fish_pager_color_selected_background --background=2a2a3f
set -U fish_pager_color_selected_prefix --bold --italics --background=2a2a3f
