...
set -l color00 "ff/f8/e7" # Base 00 - Black
set -l color01 "a1/1d/48" # Base 08 - Red
set -l color02 "a2/38/0c" # Base 0B - Green
set -l color03 "85/55/00" # Base 0A - Yellow
set -l color04 "59/40/a0" # Base 0D - Blue
set -l color05 "8c/1f/68" # Base 0E - Magenta
set -l color06 "98/26/3e" # Base 0C - Cyan
set -l color07 "4a/2c/20" # Base 05 - White
set -l color08 "c8/a7/7a" # Base 03 - Bright Black
...
set -l color15 "21/11/0b" # Base 07 - Bright White
set -l color16 "a3/47/0a" # Base 09
set -l color17 "65/32/21" # Base 0F
set -l color18 "f7/eb/d3" # Base 01
set -l color19 "ea/d6/b8" # Base 02
set -l color20 "76/5b/45" # Base 04
set -l color21 "32/1c/14" # Base 06
set -l color_foreground "4a/2c/20" # Base 05
set -l color_background "ff/f8/e7" # Base 00
...
set -U fish_color_comment c8a77a
set -U fish_color_selection 321c14 --background=ead6b8
set -U fish_color_operator magenta
set -U fish_color_escape a3470a
set -U fish_color_autosuggestion c8a77a
...
set -U fish_color_search_match yellow --background=ead6b8
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress f7ebd3 --background=765b45
set -U fish_pager_color_background --background=fff8e7
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description a3470a
set -U fish_pager_color_selected_background --background=ead6b8
set -U fish_pager_color_selected_prefix --bold --italics --background=ead6b8
...
# Set theme
set -Ux BASE16_THEME arroz-con-dulce

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "fff8e7"
  set -gx BASE16_COLOR_01_HEX "f7ebd3"
  set -gx BASE16_COLOR_02_HEX "ead6b8"
  set -gx BASE16_COLOR_03_HEX "c8a77a"
  set -gx BASE16_COLOR_04_HEX "765b45"
  set -gx BASE16_COLOR_05_HEX "4a2c20"
  set -gx BASE16_COLOR_06_HEX "321c14"
  set -gx BASE16_COLOR_07_HEX "21110b"
  set -gx BASE16_COLOR_08_HEX "a11d48"
  set -gx BASE16_COLOR_09_HEX "a3470a"
  set -gx BASE16_COLOR_0A_HEX "855500"
  set -gx BASE16_COLOR_0B_HEX "a2380c"
  set -gx BASE16_COLOR_0C_HEX "98263e"
  set -gx BASE16_COLOR_0D_HEX "5940a0"
  set -gx BASE16_COLOR_0E_HEX "8c1f68"
  set -gx BASE16_COLOR_0F_HEX "653221"
end
