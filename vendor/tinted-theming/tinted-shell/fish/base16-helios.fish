...
set -U fish_color_selection dddddd --background=53585b
set -U fish_color_operator magenta
set -U fish_color_escape eb8413
...
set -U fish_color_search_match yellow --background=53585b
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 383c3e --background=cdcdcd
set -U fish_pager_color_background --background=1d2021
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description eb8413
set -U fish_pager_color_selected_background --background=53585b
set -U fish_pager_color_selected_prefix --bold --italics --background=53585b
