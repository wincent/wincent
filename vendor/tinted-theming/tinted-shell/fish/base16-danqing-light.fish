...
set -U fish_color_selection 434846 --background=e0f0ef
...
set -U fish_color_search_match yellow --background=e0f0ef
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress ecf6f2 --background=9da8a3
set -U fish_pager_color_background --background=fcfefd
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description b38a61
set -U fish_pager_color_selected_background --background=e0f0ef
set -U fish_pager_color_selected_prefix --bold --italics --background=e0f0ef
