...
set -U fish_color_selection eeeeee --background=3b758c
set -U fish_color_operator magenta
set -U fish_color_escape db7b55
...
set -U fish_color_search_match yellow --background=3b758c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 282a2b --background=43a5d5
set -U fish_pager_color_background --background=151718
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description db7b55
set -U fish_pager_color_selected_background --background=3b758c
set -U fish_pager_color_selected_prefix --bold --italics --background=3b758c
