...
set -U fish_color_selection 2f2f35 --background=d6d6d6
set -U fish_color_operator magenta
set -U fish_color_escape fb8b05
...
set -U fish_color_search_match yellow --background=d6d6d6
...
set -U fish_pager_color_description fb8b05
set -U fish_pager_color_selected_background --background=d6d6d6
set -U fish_pager_color_selected_prefix --bold --italics --background=d6d6d6
