...
set -l color04 "b8/bb/26" # Base 0D - Blue
set -l color05 "96/bd/a2" # Base 0E - Magenta
set -l color06 "5f/6c/1f" # Base 0C - Cyan
set -l color07 "d5/c4/a1" # Base 05 - White
set -l color08 "66/5c/50" # Base 03 - Bright Black
...
set -U fish_color_comment 665c50
set -U fish_color_selection ebdbb2 --background=504945
set -U fish_color_operator magenta
set -U fish_color_escape fe8019
set -U fish_color_autosuggestion 665c50
...
set -U fish_pager_color_description fe8019
...
# Set theme
set -Ux BASE16_THEME gruvbox-dark-medium-forest
...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  ...
  set -gx BASE16_COLOR_03_HEX "665c50"
  ...
  set -gx BASE16_COLOR_0C_HEX "5f6c1f"
  set -gx BASE16_COLOR_0D_HEX "b8bb26"
  set -gx BASE16_COLOR_0E_HEX "96bda2"
