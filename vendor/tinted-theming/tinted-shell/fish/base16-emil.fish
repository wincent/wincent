...
set -U fish_color_selection 22223a --background=9e9eaf
set -U fish_color_operator magenta
set -U fish_color_escape d22a8b
...
set -U fish_color_search_match yellow --background=9e9eaf
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress bebed2 --background=505063
set -U fish_pager_color_background --background=efefef
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d22a8b
set -U fish_pager_color_selected_background --background=9e9eaf
set -U fish_pager_color_selected_prefix --bold --italics --background=9e9eaf
