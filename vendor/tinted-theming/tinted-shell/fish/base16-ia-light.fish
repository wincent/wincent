...
set -U fish_color_selection e8e8e8 --background=bde5f2
set -U fish_color_operator magenta
set -U fish_color_escape c43e18
...
set -U fish_color_search_match yellow --background=bde5f2
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress dedede --background=767676
set -U fish_pager_color_background --background=f6f6f6
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c43e18
set -U fish_pager_color_selected_background --background=bde5f2
set -U fish_pager_color_selected_prefix --bold --italics --background=bde5f2
