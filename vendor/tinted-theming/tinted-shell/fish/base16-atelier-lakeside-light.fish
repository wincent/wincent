...
set -U fish_color_selection 1f292e --background=7ea2b4
...
set -U fish_color_search_match yellow --background=7ea2b4
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress c1e4f6 --background=5a7b8c
set -U fish_pager_color_background --background=ebf8ff
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 935c25
set -U fish_pager_color_selected_background --background=7ea2b4
set -U fish_pager_color_selected_prefix --bold --italics --background=7ea2b4
