...
set -l color09 "d8/13/29" # Base 12 - Bright Red
set -l color10 "d2/ff/af" # Base 14 - Bright Green
set -l color11 "ff/ee/50" # Base 13 - Bright Yellow
set -l color12 "00/74/ea" # Base 16 - Bright Blue
set -l color13 "fd/d5/e5" # Base 17 - Bright Magenta
set -l color14 "79/eb/d5" # Base 15 - Bright Cyan
