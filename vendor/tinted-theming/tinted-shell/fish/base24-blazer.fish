...
set -l color09 "db/bd/bd" # Base 12 - Bright Red
set -l color10 "bd/db/bd" # Base 14 - Bright Green
set -l color11 "db/db/bd" # Base 13 - Bright Yellow
set -l color12 "bd/bd/db" # Base 16 - Bright Blue
set -l color13 "db/bd/db" # Base 17 - Bright Magenta
set -l color14 "bd/db/db" # Base 15 - Bright Cyan
