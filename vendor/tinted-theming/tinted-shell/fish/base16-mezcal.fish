...
set -l color00 "13/11/0e" # Base 00 - Black
set -l color01 "da/6e/54" # Base 08 - Red
set -l color02 "a8/b8/4a" # Base 0B - Green
set -l color03 "d9/a4/41" # Base 0A - Yellow
set -l color04 "8a/a6/c0" # Base 0D - Blue
set -l color05 "c2/8a/a8" # Base 0E - Magenta
set -l color06 "6f/c8/ae" # Base 0C - Cyan
set -l color07 "e0/d8/c8" # Base 05 - White
set -l color08 "6e/64/50" # Base 03 - Bright Black
...
set -l color15 "f2/ea/d6" # Base 07 - Bright White
set -l color16 "d9/a4/41" # Base 09
set -l color17 "4e/46/2c" # Base 0F
set -l color18 "22/1f/14" # Base 01
set -l color19 "36/30/1e" # Base 02
set -l color20 "a7/9e/8c" # Base 04
set -l color21 "e9/e1/cf" # Base 06
set -l color_foreground "e0/d8/c8" # Base 05
set -l color_background "13/11/0e" # Base 00
...
set -U fish_color_comment 6e6450
set -U fish_color_selection e9e1cf --background=36301e
set -U fish_color_operator magenta
set -U fish_color_escape d9a441
set -U fish_color_autosuggestion 6e6450
...
set -U fish_color_search_match yellow --background=36301e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 221f14 --background=a79e8c
set -U fish_pager_color_background --background=13110e
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d9a441
set -U fish_pager_color_selected_background --background=36301e
set -U fish_pager_color_selected_prefix --bold --italics --background=36301e
...
# Set theme
set -Ux BASE16_THEME mezcal

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "13110e"
  set -gx BASE16_COLOR_01_HEX "221f14"
  set -gx BASE16_COLOR_02_HEX "36301e"
  set -gx BASE16_COLOR_03_HEX "6e6450"
  set -gx BASE16_COLOR_04_HEX "a79e8c"
  set -gx BASE16_COLOR_05_HEX "e0d8c8"
  set -gx BASE16_COLOR_06_HEX "e9e1cf"
  set -gx BASE16_COLOR_07_HEX "f2ead6"
  set -gx BASE16_COLOR_08_HEX "da6e54"
  set -gx BASE16_COLOR_09_HEX "d9a441"
  set -gx BASE16_COLOR_0A_HEX "d9a441"
  set -gx BASE16_COLOR_0B_HEX "a8b84a"
  set -gx BASE16_COLOR_0C_HEX "6fc8ae"
  set -gx BASE16_COLOR_0D_HEX "8aa6c0"
  set -gx BASE16_COLOR_0E_HEX "c28aa8"
  set -gx BASE16_COLOR_0F_HEX "4e462c"
end
