...
set -U fish_color_selection 575279 --background=f2e9de
set -U fish_color_operator magenta
set -U fish_color_escape ea9d34
...
set -U fish_color_search_match yellow --background=f2e9de
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress fffaf3 --background=797593
set -U fish_pager_color_background --background=faf4ed
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ea9d34
set -U fish_pager_color_selected_background --background=f2e9de
set -U fish_pager_color_selected_prefix --bold --italics --background=f2e9de
