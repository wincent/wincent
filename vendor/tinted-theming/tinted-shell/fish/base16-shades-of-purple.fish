...
set -U fish_color_selection ff77ff --background=f1d000
set -U fish_color_operator magenta
set -U fish_color_escape f92a1c
...
set -U fish_color_search_match yellow --background=f1d000
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 43d426 --background=6871ff
set -U fish_pager_color_background --background=1e1e3f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f92a1c
set -U fish_pager_color_selected_background --background=f1d000
set -U fish_pager_color_selected_prefix --bold --italics --background=f1d000
