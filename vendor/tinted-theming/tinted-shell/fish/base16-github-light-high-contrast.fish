...
# Set theme
set -Ux BASE16_THEME github-light-high-contrast

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "ffffff"
  set -gx BASE16_COLOR_01_HEX "e7ecf0"
  set -gx BASE16_COLOR_02_HEX "acb6c0"
  set -gx BASE16_COLOR_03_HEX "88929d"
  set -gx BASE16_COLOR_04_HEX "66707b"
  set -gx BASE16_COLOR_05_HEX "343b43"
  set -gx BASE16_COLOR_06_HEX "20252c"
  set -gx BASE16_COLOR_07_HEX "0e1116"
  set -gx BASE16_COLOR_08_HEX "702c00"
  set -gx BASE16_COLOR_09_HEX "023b95"
  set -gx BASE16_COLOR_0A_HEX "956400"
  set -gx BASE16_COLOR_0B_HEX "032563"
  set -gx BASE16_COLOR_0C_HEX "024c1a"
  set -gx BASE16_COLOR_0D_HEX "622cbc"
  set -gx BASE16_COLOR_0E_HEX "a0111f"
  set -gx BASE16_COLOR_0F_HEX "6e011a"
end
