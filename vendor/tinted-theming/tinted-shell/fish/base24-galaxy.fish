...
set -l color09 "fa/8b/8e" # Base 12 - Bright Red
set -l color10 "34/bb/99" # Base 14 - Bright Green
set -l color11 "ff/ff/55" # Base 13 - Bright Yellow
set -l color12 "58/9c/f5" # Base 16 - Bright Blue
set -l color13 "e7/55/98" # Base 17 - Bright Magenta
set -l color14 "39/78/bb" # Base 15 - Bright Cyan
