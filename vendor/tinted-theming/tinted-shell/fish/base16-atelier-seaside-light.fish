...
set -U fish_color_selection 242924 --background=8ca68c
...
set -U fish_color_search_match yellow --background=8ca68c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress cfe8cf --background=687d68
set -U fish_pager_color_background --background=f4fbf4
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 87711d
set -U fish_pager_color_selected_background --background=8ca68c
set -U fish_pager_color_selected_prefix --bold --italics --background=8ca68c
