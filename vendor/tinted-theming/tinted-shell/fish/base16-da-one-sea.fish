...
set -U fish_color_selection ffffff --background=525866
set -U fish_color_operator magenta
set -U fish_color_escape ffc387
...
set -U fish_color_search_match yellow --background=525866
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 374059 --background=c8c8c8
set -U fish_pager_color_background --background=22273d
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffc387
set -U fish_pager_color_selected_background --background=525866
set -U fish_pager_color_selected_prefix --bold --italics --background=525866
