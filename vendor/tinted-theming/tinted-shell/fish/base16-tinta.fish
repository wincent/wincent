...
set -l color00 "10/10/12" # Base 00 - Black
set -l color01 "d0/72/6a" # Base 08 - Red
set -l color02 "9a/a8/90" # Base 0B - Green
set -l color03 "c8/b8/6a" # Base 0A - Yellow
set -l color04 "8a/9a/b0" # Base 0D - Blue
set -l color05 "b0/a0/b8" # Base 0E - Magenta
set -l color06 "80/b8/b4" # Base 0C - Cyan
set -l color07 "d8/d6/d0" # Base 05 - White
set -l color08 "62/62/6a" # Base 03 - Bright Black
...
set -l color15 "ee/ec/e6" # Base 07 - Bright White
set -l color16 "e8/84/3a" # Base 09
set -l color17 "4a/4a/50" # Base 0F
set -l color18 "20/20/23" # Base 01
set -l color19 "2c/2c/30" # Base 02
set -l color20 "9d/9c/9d" # Base 04
set -l color21 "e3/e1/db" # Base 06
set -l color_foreground "d8/d6/d0" # Base 05
set -l color_background "10/10/12" # Base 00
...
set -U fish_color_comment 62626a
set -U fish_color_selection e3e1db --background=2c2c30
set -U fish_color_operator magenta
set -U fish_color_escape e8843a
set -U fish_color_autosuggestion 62626a
...
set -U fish_color_search_match yellow --background=2c2c30
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 202023 --background=9d9c9d
set -U fish_pager_color_background --background=101012
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e8843a
set -U fish_pager_color_selected_background --background=2c2c30
set -U fish_pager_color_selected_prefix --bold --italics --background=2c2c30
...
# Set theme
set -Ux BASE16_THEME tinta

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "101012"
  set -gx BASE16_COLOR_01_HEX "202023"
  set -gx BASE16_COLOR_02_HEX "2c2c30"
  set -gx BASE16_COLOR_03_HEX "62626a"
  set -gx BASE16_COLOR_04_HEX "9d9c9d"
  set -gx BASE16_COLOR_05_HEX "d8d6d0"
  set -gx BASE16_COLOR_06_HEX "e3e1db"
  set -gx BASE16_COLOR_07_HEX "eeece6"
  set -gx BASE16_COLOR_08_HEX "d0726a"
  set -gx BASE16_COLOR_09_HEX "e8843a"
  set -gx BASE16_COLOR_0A_HEX "c8b86a"
  set -gx BASE16_COLOR_0B_HEX "9aa890"
  set -gx BASE16_COLOR_0C_HEX "80b8b4"
  set -gx BASE16_COLOR_0D_HEX "8a9ab0"
  set -gx BASE16_COLOR_0E_HEX "b0a0b8"
  set -gx BASE16_COLOR_0F_HEX "4a4a50"
end
