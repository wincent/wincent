...
set -U fish_color_selection 333333 --background=cccccc
set -U fish_color_operator magenta
set -U fish_color_escape d7691d
...
set -U fish_color_search_match yellow --background=cccccc
...
set -U fish_pager_color_description d7691d
set -U fish_pager_color_selected_background --background=cccccc
set -U fish_pager_color_selected_prefix --bold --italics --background=cccccc
