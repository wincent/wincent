...
set -U fish_color_selection 303338 --background=f2e6d4
...
set -U fish_color_search_match yellow --background=f2e6d4
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress fff7ed --background=8f8f8f
set -U fish_pager_color_background --background=fffdfb
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ba823a
set -U fish_pager_color_selected_background --background=f2e6d4
set -U fish_pager_color_selected_prefix --bold --italics --background=f2e6d4
