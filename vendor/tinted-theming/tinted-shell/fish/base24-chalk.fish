...
set -l color09 "fb/9f/b1" # Base 12 - Bright Red
set -l color10 "ac/c2/67" # Base 14 - Bright Green
set -l color11 "ed/a9/87" # Base 13 - Bright Yellow
set -l color12 "6f/c2/ef" # Base 16 - Bright Blue
set -l color13 "e1/a3/ee" # Base 17 - Bright Magenta
set -l color14 "12/cf/c0" # Base 15 - Bright Cyan
