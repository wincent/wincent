...
set -U fish_color_selection dcdfe4 --background=2e303e
set -U fish_color_operator magenta
set -U fish_color_escape fab795
...
set -U fish_color_search_match yellow --background=2e303e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 232530 --background=9da0a2
set -U fish_pager_color_background --background=1c1e26
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description fab795
set -U fish_pager_color_selected_background --background=2e303e
set -U fish_pager_color_selected_prefix --bold --italics --background=2e303e
