...
set -U fish_color_selection 414141 --background=d9d9d9
set -U fish_color_operator magenta
set -U fish_color_escape f9f1a5
...
set -U fish_color_search_match yellow --background=d9d9d9
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e5e5e5 --background=ababab
set -U fish_pager_color_background --background=f2f2f2
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f9f1a5
set -U fish_pager_color_selected_background --background=d9d9d9
set -U fish_pager_color_selected_prefix --bold --italics --background=d9d9d9
