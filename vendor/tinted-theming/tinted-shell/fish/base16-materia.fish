...
set -U fish_color_selection d5dbe5 --background=37474f
set -U fish_color_operator magenta
set -U fish_color_escape ea9560
...
set -U fish_color_search_match yellow --background=37474f
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2c393f --background=c9ccd3
set -U fish_pager_color_background --background=263238
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ea9560
set -U fish_pager_color_selected_background --background=37474f
set -U fish_pager_color_selected_prefix --bold --italics --background=37474f
