...
set -l color00 "1a/0f/0a" # Base 00 - Black
set -l color01 "f2/68/5a" # Base 08 - Red
set -l color02 "b8/c2/4a" # Base 0B - Green
set -l color03 "f0/b2/3a" # Base 0A - Yellow
set -l color04 "9a/a6/e0" # Base 0D - Blue
set -l color05 "e6/8a/a2" # Base 0E - Magenta
set -l color06 "6b/c8/b8" # Base 0C - Cyan
set -l color07 "f0/d8/c0" # Base 05 - White
set -l color08 "7a/61/50" # Base 03 - Bright Black
...
set -l color15 "fb/ea/d8" # Base 07 - Bright White
set -l color16 "ff/7a/4d" # Base 09
set -l color17 "5a/3a/28" # Base 0F
set -l color18 "2b/1c/14" # Base 01
set -l color19 "45/26/1a" # Base 02
set -l color20 "b5/9d/88" # Base 04
set -l color21 "f6/e1/cc" # Base 06
set -l color_foreground "f0/d8/c0" # Base 05
set -l color_background "1a/0f/0a" # Base 00
...
set -U fish_color_comment 7a6150
set -U fish_color_selection f6e1cc --background=45261a
set -U fish_color_operator magenta
set -U fish_color_escape ff7a4d
set -U fish_color_autosuggestion 7a6150
...
set -U fish_color_search_match yellow --background=45261a
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2b1c14 --background=b59d88
set -U fish_pager_color_background --background=1a0f0a
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff7a4d
set -U fish_pager_color_selected_background --background=45261a
set -U fish_pager_color_selected_prefix --bold --italics --background=45261a
...
# Set theme
set -Ux BASE16_THEME brasa

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "1a0f0a"
  set -gx BASE16_COLOR_01_HEX "2b1c14"
  set -gx BASE16_COLOR_02_HEX "45261a"
  set -gx BASE16_COLOR_03_HEX "7a6150"
  set -gx BASE16_COLOR_04_HEX "b59d88"
  set -gx BASE16_COLOR_05_HEX "f0d8c0"
  set -gx BASE16_COLOR_06_HEX "f6e1cc"
  set -gx BASE16_COLOR_07_HEX "fbead8"
  set -gx BASE16_COLOR_08_HEX "f2685a"
  set -gx BASE16_COLOR_09_HEX "ff7a4d"
  set -gx BASE16_COLOR_0A_HEX "f0b23a"
  set -gx BASE16_COLOR_0B_HEX "b8c24a"
  set -gx BASE16_COLOR_0C_HEX "6bc8b8"
  set -gx BASE16_COLOR_0D_HEX "9aa6e0"
  set -gx BASE16_COLOR_0E_HEX "e68aa2"
  set -gx BASE16_COLOR_0F_HEX "5a3a28"
end
