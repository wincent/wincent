...
set -U fish_color_selection 3b4252 --background=b8c5db
set -U fish_color_operator magenta
set -U fish_color_escape ac4426
...
set -U fish_color_search_match yellow --background=b8c5db
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress c2d0e7 --background=60728c
set -U fish_pager_color_background --background=e5e9f0
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ac4426
set -U fish_pager_color_selected_background --background=b8c5db
set -U fish_pager_color_selected_prefix --bold --italics --background=b8c5db
