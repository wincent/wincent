...
set -l color09 "ff/61/6e" # Base 12 - Bright Red
set -l color10 "a5/e0/75" # Base 14 - Bright Green
set -l color11 "f0/a4/5d" # Base 13 - Bright Yellow
set -l color12 "4d/c4/ff" # Base 16 - Bright Blue
set -l color13 "de/73/ff" # Base 17 - Bright Magenta
set -l color14 "4c/d1/e0" # Base 15 - Bright Cyan
