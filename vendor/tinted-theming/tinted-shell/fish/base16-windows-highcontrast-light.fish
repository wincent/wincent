...
set -U fish_color_selection 2a2a2a --background=d4d4d4
...
set -U fish_color_search_match yellow --background=d4d4d4
...
set -U fish_pager_color_selected_background --background=d4d4d4
set -U fish_pager_color_selected_prefix --bold --italics --background=d4d4d4
