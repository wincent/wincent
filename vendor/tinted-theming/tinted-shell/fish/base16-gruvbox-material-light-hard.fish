...
set -U fish_color_selection 3c3836 --background=e0cfa9
set -U fish_color_operator magenta
set -U fish_color_escape c35e0a
...
set -U fish_color_search_match yellow --background=e0cfa9
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress fbf1c7 --background=c9b99a
set -U fish_pager_color_background --background=f9f5d7
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c35e0a
set -U fish_pager_color_selected_background --background=e0cfa9
set -U fish_pager_color_selected_prefix --bold --italics --background=e0cfa9
