...
set -l color09 "f1/4c/4c" # Base 12 - Bright Red
set -l color10 "23/d1/8b" # Base 14 - Bright Green
set -l color11 "f5/f5/43" # Base 13 - Bright Yellow
set -l color12 "3b/8e/ea" # Base 16 - Bright Blue
set -l color13 "d6/70/d6" # Base 17 - Bright Magenta
set -l color14 "29/b8/db" # Base 15 - Bright Cyan
