...
set -U fish_color_selection 2a3b32 --background=b9d0c3
set -U fish_color_operator magenta
set -U fish_color_escape f9461c
...
set -U fish_color_search_match yellow --background=b9d0c3
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress d1e0d7 --background=4b5a51
set -U fish_pager_color_background --background=e8f0ea
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f9461c
set -U fish_pager_color_selected_background --background=b9d0c3
set -U fish_pager_color_selected_prefix --bold --italics --background=b9d0c3
