...
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "22272e"
  set -gx BASE16_COLOR_01_HEX "2d333b"
  set -gx BASE16_COLOR_02_HEX "545d68"
  set -gx BASE16_COLOR_03_HEX "636e7b"
  set -gx BASE16_COLOR_04_HEX "768390"
  set -gx BASE16_COLOR_05_HEX "adbac7"
  set -gx BASE16_COLOR_06_HEX "cdd9e5"
  set -gx BASE16_COLOR_07_HEX "ffffff"
  set -gx BASE16_COLOR_08_HEX "f69d50"
  set -gx BASE16_COLOR_09_HEX "6cb6ff"
  set -gx BASE16_COLOR_0A_HEX "ae7c14"
  set -gx BASE16_COLOR_0B_HEX "96d0ff"
  set -gx BASE16_COLOR_0C_HEX "8ddb8c"
  set -gx BASE16_COLOR_0D_HEX "dcbdfb"
  set -gx BASE16_COLOR_0E_HEX "f47067"
