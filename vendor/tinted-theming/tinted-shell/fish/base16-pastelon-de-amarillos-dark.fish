...
set -l color01 "ff/64/6a" # Base 08 - Red
set -l color02 "3c/cb/83" # Base 0B - Green
set -l color03 "ff/c8/4a" # Base 0A - Yellow
set -l color04 "5a/9f/e6" # Base 0D - Blue
set -l color05 "d9/78/cf" # Base 0E - Magenta
set -l color06 "35/c4/b6" # Base 0C - Cyan
...
set -l color16 "f9/9a/32" # Base 09
set -l color17 "e2/76/4a" # Base 0F
...
set -U fish_color_escape f99a32
...
set -U fish_pager_color_description f99a32
...
# Set theme
set -Ux BASE16_THEME pastelon-de-amarillos-dark

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "180d18"
  set -gx BASE16_COLOR_01_HEX "2a1424"
  set -gx BASE16_COLOR_02_HEX "432031"
  set -gx BASE16_COLOR_03_HEX "a0747c"
  set -gx BASE16_COLOR_04_HEX "c39a89"
  set -gx BASE16_COLOR_05_HEX "ffe0a3"
  set -gx BASE16_COLOR_06_HEX "ffebc5"
  set -gx BASE16_COLOR_07_HEX "fff7e6"
  set -gx BASE16_COLOR_08_HEX "ff646a"
  set -gx BASE16_COLOR_09_HEX "f99a32"
  set -gx BASE16_COLOR_0A_HEX "ffc84a"
  set -gx BASE16_COLOR_0B_HEX "3ccb83"
  set -gx BASE16_COLOR_0C_HEX "35c4b6"
  set -gx BASE16_COLOR_0D_HEX "5a9fe6"
  set -gx BASE16_COLOR_0E_HEX "d978cf"
  set -gx BASE16_COLOR_0F_HEX "e2764a"
end
