...
set -U fish_color_selection dedae2 --background=5a496e
set -U fish_color_operator magenta
set -U fish_color_escape 5ba2b6
...
set -U fish_color_search_match yellow --background=5a496e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 392551 --background=9c92a8
set -U fish_pager_color_background --background=190134
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 5ba2b6
set -U fish_pager_color_selected_background --background=5a496e
set -U fish_pager_color_selected_prefix --bold --italics --background=5a496e
