...
set -U fish_color_selection 3a3a2e --background=bdbd97
set -U fish_color_operator magenta
set -U fish_color_escape ffdc99
...
set -U fish_color_search_match yellow --background=bdbd97
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress dedeb2 --background=7c7c63
set -U fish_pager_color_background --background=ffffcc
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffdc99
set -U fish_pager_color_selected_background --background=bdbd97
set -U fish_pager_color_selected_prefix --bold --italics --background=bdbd97
