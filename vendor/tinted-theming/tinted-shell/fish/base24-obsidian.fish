...
set -l color09 "ff/00/03" # Base 12 - Bright Red
set -l color10 "92/c7/63" # Base 14 - Bright Green
set -l color11 "fe/f7/73" # Base 13 - Bright Yellow
set -l color12 "a0/d6/ff" # Base 16 - Bright Blue
