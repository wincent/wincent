...
set -l color09 "ff/00/80" # Base 12 - Bright Red
set -l color10 "66/ff/66" # Base 14 - Bright Green
set -l color11 "f3/d6/4e" # Base 13 - Bright Yellow
set -l color12 "70/9a/ed" # Base 16 - Bright Blue
set -l color13 "db/67/e6" # Base 17 - Bright Magenta
set -l color14 "79/df/f2" # Base 15 - Bright Cyan
