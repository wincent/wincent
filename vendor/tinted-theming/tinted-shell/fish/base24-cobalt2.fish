...
set -l color09 "f4/0d/17" # Base 12 - Bright Red
set -l color10 "3b/cf/1d" # Base 14 - Bright Green
set -l color11 "ec/c8/09" # Base 13 - Bright Yellow
set -l color12 "55/55/ff" # Base 16 - Bright Blue
set -l color13 "ff/55/ff" # Base 17 - Bright Magenta
set -l color14 "6a/e3/f9" # Base 15 - Bright Cyan
