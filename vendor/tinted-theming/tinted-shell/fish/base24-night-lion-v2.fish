...
set -l color10 "7d/f6/1c" # Base 14 - Bright Green
set -l color11 "ff/ff/55" # Base 13 - Bright Yellow
set -l color12 "62/ca/e7" # Base 16 - Bright Blue
set -l color13 "ff/9a/f5" # Base 17 - Bright Magenta
set -l color14 "00/cc/d7" # Base 15 - Bright Cyan
