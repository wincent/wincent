...
set -U fish_color_selection c1e4f6 --background=516d7b
set -U fish_color_operator magenta
set -U fish_color_escape 935c25
...
set -U fish_color_search_match yellow --background=516d7b
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1f292e --background=7195a8
set -U fish_pager_color_background --background=161b1d
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 935c25
set -U fish_pager_color_selected_background --background=516d7b
set -U fish_pager_color_selected_prefix --bold --italics --background=516d7b
