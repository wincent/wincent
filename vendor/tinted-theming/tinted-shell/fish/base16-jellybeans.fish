...
set -l color01 "ff/a1/a1" # Base 08 - Red
set -l color02 "bd/de/ab" # Base 0B - Green
set -l color03 "ff/dc/a0" # Base 0A - Yellow
set -l color04 "b1/d8/f6" # Base 0D - Blue
set -l color05 "fb/da/ff" # Base 0E - Magenta
set -l color06 "1a/b2/a8" # Base 0C - Cyan
...
# Set theme
set -Ux BASE16_THEME jellybeans

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "121212"
  set -gx BASE16_COLOR_01_HEX "929292"
  set -gx BASE16_COLOR_02_HEX "bdbdbd"
  set -gx BASE16_COLOR_03_HEX "c5c5c5"
  ...
  set -gx BASE16_COLOR_08_HEX "ffa1a1"
  set -gx BASE16_COLOR_09_HEX "ffba7b"
  set -gx BASE16_COLOR_0A_HEX "ffdca0"
  set -gx BASE16_COLOR_0B_HEX "bddeab"
  set -gx BASE16_COLOR_0C_HEX "1ab2a8"
  set -gx BASE16_COLOR_0D_HEX "b1d8f6"
  set -gx BASE16_COLOR_0E_HEX "fbdaff"
  set -gx BASE16_COLOR_0F_HEX "713939"
end
