...
set -U fish_color_selection dedeb2 --background=5b5b49
...
set -U fish_color_search_match yellow --background=5b5b49
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 3a3a2e --background=9c9c7d
set -U fish_pager_color_background --background=191914
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ffdc99
set -U fish_pager_color_selected_background --background=5b5b49
set -U fish_pager_color_selected_prefix --bold --italics --background=5b5b49
