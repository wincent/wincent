...
set -U fish_color_selection 293256 --background=979db4
set -U fish_color_operator magenta
set -U fish_color_escape c76b29
...
set -U fish_color_search_match yellow --background=979db4
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress dfe2f1 --background=6b7394
set -U fish_pager_color_background --background=f5f7ff
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description c76b29
set -U fish_pager_color_selected_background --background=979db4
set -U fish_pager_color_selected_prefix --bold --italics --background=979db4
