...
set -U fish_color_selection 040404 --background=ababab
set -U fish_color_operator magenta
set -U fish_color_escape e09448
...
set -U fish_color_search_match yellow --background=ababab
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e0e0e0 --background=343434
set -U fish_pager_color_background --background=f9f9f9
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e09448
set -U fish_pager_color_selected_background --background=ababab
set -U fish_pager_color_selected_prefix --bold --italics --background=ababab
