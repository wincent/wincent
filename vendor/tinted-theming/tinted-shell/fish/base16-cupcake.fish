...
set -U fish_color_selection 72677e --background=d8d5dd
set -U fish_color_operator magenta
set -U fish_color_escape ebb790
...
set -U fish_color_search_match yellow --background=d8d5dd
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress f2f1f4 --background=a59daf
set -U fish_pager_color_background --background=fbf1f2
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ebb790
set -U fish_pager_color_selected_background --background=d8d5dd
set -U fish_pager_color_selected_prefix --bold --italics --background=d8d5dd
