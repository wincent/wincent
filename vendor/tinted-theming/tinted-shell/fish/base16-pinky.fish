...
set -U fish_color_selection ffffff --background=1d1b1d
set -U fish_color_operator magenta
set -U fish_color_escape 00ff66
...
set -U fish_color_search_match yellow --background=1d1b1d
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1b181b --background=e7dbdb
set -U fish_pager_color_background --background=171517
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 00ff66
set -U fish_pager_color_selected_background --background=1d1b1d
set -U fish_pager_color_selected_prefix --bold --italics --background=1d1b1d
