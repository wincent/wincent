...
set -U fish_color_selection 2c3138 --background=d8d4cb
set -U fish_color_operator magenta
set -U fish_color_escape bf3e05
...
set -U fish_color_search_match yellow --background=d8d4cb
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e7e2d9 --background=5a5f66
set -U fish_pager_color_background --background=f5f0e7
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description bf3e05
set -U fish_pager_color_selected_background --background=d8d4cb
set -U fish_pager_color_selected_prefix --bold --italics --background=d8d4cb
