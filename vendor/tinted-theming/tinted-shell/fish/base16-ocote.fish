...
set -l color00 "14/10/0c" # Base 00 - Black
set -l color01 "e8/63/5a" # Base 08 - Red
set -l color02 "7d/c9/7a" # Base 0B - Green
set -l color03 "e8/b4/3a" # Base 0A - Yellow
set -l color04 "82/a6/e0" # Base 0D - Blue
set -l color05 "c5/8a/e0" # Base 0E - Magenta
set -l color06 "6d/d8/c8" # Base 0C - Cyan
set -l color07 "e7/dc/c6" # Base 05 - White
set -l color08 "6b/62/53" # Base 03 - Bright Black
...
set -l color15 "fa/f6/ec" # Base 07 - Bright White
set -l color16 "e8/84/3a" # Base 09
set -l color17 "4a/3e/2c" # Base 0F
set -l color18 "21/1b/13" # Base 01
set -l color19 "3a/2e/1c" # Base 02
set -l color20 "a9/9f/8d" # Base 04
set -l color21 "f1/e9/d9" # Base 06
set -l color_foreground "e7/dc/c6" # Base 05
set -l color_background "14/10/0c" # Base 00
...
set -U fish_color_comment 6b6253
set -U fish_color_selection f1e9d9 --background=3a2e1c
set -U fish_color_operator magenta
set -U fish_color_escape e8843a
set -U fish_color_autosuggestion 6b6253
...
set -U fish_color_search_match yellow --background=3a2e1c
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 211b13 --background=a99f8d
set -U fish_pager_color_background --background=14100c
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description e8843a
set -U fish_pager_color_selected_background --background=3a2e1c
set -U fish_pager_color_selected_prefix --bold --italics --background=3a2e1c
...
# Set theme
set -Ux BASE16_THEME ocote

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "14100c"
  set -gx BASE16_COLOR_01_HEX "211b13"
  set -gx BASE16_COLOR_02_HEX "3a2e1c"
  set -gx BASE16_COLOR_03_HEX "6b6253"
  set -gx BASE16_COLOR_04_HEX "a99f8d"
  set -gx BASE16_COLOR_05_HEX "e7dcc6"
  set -gx BASE16_COLOR_06_HEX "f1e9d9"
  set -gx BASE16_COLOR_07_HEX "faf6ec"
  set -gx BASE16_COLOR_08_HEX "e8635a"
  set -gx BASE16_COLOR_09_HEX "e8843a"
  set -gx BASE16_COLOR_0A_HEX "e8b43a"
  set -gx BASE16_COLOR_0B_HEX "7dc97a"
  set -gx BASE16_COLOR_0C_HEX "6dd8c8"
  set -gx BASE16_COLOR_0D_HEX "82a6e0"
  set -gx BASE16_COLOR_0E_HEX "c58ae0"
  set -gx BASE16_COLOR_0F_HEX "4a3e2c"
end
