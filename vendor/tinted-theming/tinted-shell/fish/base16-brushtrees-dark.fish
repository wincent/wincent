...
set -U fish_color_selection c9dbdc --background=6d828e
...
set -U fish_color_search_match yellow --background=6d828e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 5a6d7a --background=98afb5
set -U fish_pager_color_background --background=485867
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description d8bba2
set -U fish_pager_color_selected_background --background=6d828e
set -U fish_pager_color_selected_prefix --bold --italics --background=6d828e
