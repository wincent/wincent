...
set -l color09 "ef/29/29" # Base 12 - Bright Red
set -l color10 "8a/e2/34" # Base 14 - Bright Green
set -l color11 "fc/e9/4f" # Base 13 - Bright Yellow
set -l color12 "72/9f/cf" # Base 16 - Bright Blue
