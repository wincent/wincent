...
set -U fish_color_selection 26232a --background=8b8792
...
set -U fish_color_search_match yellow --background=8b8792
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e2dfe7 --background=655f6d
set -U fish_pager_color_background --background=efecf4
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description aa573c
set -U fish_pager_color_selected_background --background=8b8792
set -U fish_pager_color_selected_prefix --bold --italics --background=8b8792
