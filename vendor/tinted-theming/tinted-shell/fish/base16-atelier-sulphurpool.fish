...
set -U fish_color_selection dfe2f1 --background=5e6687
...
set -U fish_color_search_match yellow --background=5e6687
...
set -U fish_pager_color_selected_background --background=5e6687
set -U fish_pager_color_selected_prefix --bold --italics --background=5e6687
