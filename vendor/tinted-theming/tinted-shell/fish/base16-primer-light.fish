...
set -U fish_color_selection 24292e --background=d1d5da
set -U fish_color_operator magenta
set -U fish_color_escape f66a0a
...
set -U fish_color_search_match yellow --background=d1d5da
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress e1e4e8 --background=444d56
set -U fish_pager_color_background --background=fafbfc
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f66a0a
set -U fish_pager_color_selected_background --background=d1d5da
set -U fish_pager_color_selected_prefix --bold --italics --background=d1d5da
