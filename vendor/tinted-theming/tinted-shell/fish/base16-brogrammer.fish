...
set -U fish_color_selection 1081d6 --background=2dc55e
set -U fish_color_operator magenta
set -U fish_color_escape de352e
...
set -U fish_color_search_match yellow --background=2dc55e
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress f81118 --background=2a84d2
set -U fish_pager_color_background --background=1f1f1f
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description de352e
set -U fish_pager_color_selected_background --background=2dc55e
set -U fish_pager_color_selected_prefix --bold --italics --background=2dc55e
