...
set -l color10 "46/5a/61" # Base 14 - Bright Green
set -l color11 "52/67/6f" # Base 13 - Bright Yellow
set -l color12 "70/81/83" # Base 16 - Bright Blue
set -l color13 "58/56/b9" # Base 17 - Bright Magenta
