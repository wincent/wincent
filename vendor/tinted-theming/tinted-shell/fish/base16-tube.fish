...
set -U fish_color_selection e7e7e8 --background=5a5758
set -U fish_color_operator magenta
set -U fish_color_escape f386a1
...
set -U fish_color_search_match yellow --background=5a5758
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 1c3f95 --background=959ca1
set -U fish_pager_color_background --background=231f20
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description f386a1
set -U fish_pager_color_selected_background --background=5a5758
set -U fish_pager_color_selected_prefix --bold --italics --background=5a5758
