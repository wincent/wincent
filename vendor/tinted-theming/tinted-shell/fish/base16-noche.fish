...
set -l color00 "0c/0e/16" # Base 00 - Black
set -l color01 "e2/72/7e" # Base 08 - Red
set -l color02 "7c/c5/96" # Base 0B - Green
set -l color03 "d8/c0/62" # Base 0A - Yellow
set -l color04 "7a/a0/e8" # Base 0D - Blue
set -l color05 "b7/9a/e0" # Base 0E - Magenta
set -l color06 "6d/d8/d0" # Base 0C - Cyan
set -l color07 "cb/d4/ec" # Base 05 - White
set -l color08 "5a/61/78" # Base 03 - Bright Black
...
set -l color15 "e6/ec/fa" # Base 07 - Bright White
set -l color16 "82/a6/e0" # Base 09
set -l color17 "3a/42/60" # Base 0F
set -l color18 "18/1c/2c" # Base 01
set -l color19 "23/2a/40" # Base 02
set -l color20 "93/9b/b2" # Base 04
set -l color21 "d9/e0/f3" # Base 06
set -l color_foreground "cb/d4/ec" # Base 05
set -l color_background "0c/0e/16" # Base 00
...
set -U fish_color_comment 5a6178
set -U fish_color_selection d9e0f3 --background=232a40
set -U fish_color_operator magenta
set -U fish_color_escape 82a6e0
set -U fish_color_autosuggestion 5a6178
...
set -U fish_color_search_match yellow --background=232a40
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 181c2c --background=939bb2
set -U fish_pager_color_background --background=0c0e16
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 82a6e0
set -U fish_pager_color_selected_background --background=232a40
set -U fish_pager_color_selected_prefix --bold --italics --background=232a40
...
# Set theme
set -Ux BASE16_THEME noche

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "0c0e16"
  set -gx BASE16_COLOR_01_HEX "181c2c"
  set -gx BASE16_COLOR_02_HEX "232a40"
  set -gx BASE16_COLOR_03_HEX "5a6178"
  set -gx BASE16_COLOR_04_HEX "939bb2"
  set -gx BASE16_COLOR_05_HEX "cbd4ec"
  set -gx BASE16_COLOR_06_HEX "d9e0f3"
  set -gx BASE16_COLOR_07_HEX "e6ecfa"
  set -gx BASE16_COLOR_08_HEX "e2727e"
  set -gx BASE16_COLOR_09_HEX "82a6e0"
  set -gx BASE16_COLOR_0A_HEX "d8c062"
  set -gx BASE16_COLOR_0B_HEX "7cc596"
  set -gx BASE16_COLOR_0C_HEX "6dd8d0"
  set -gx BASE16_COLOR_0D_HEX "7aa0e8"
  set -gx BASE16_COLOR_0E_HEX "b79ae0"
  set -gx BASE16_COLOR_0F_HEX "3a4260"
end
