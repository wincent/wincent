...
set -l color09 "ff/cc/d8" # Base 12 - Bright Red
set -l color10 "bd/ff/a8" # Base 14 - Bright Green
set -l color11 "d0/cb/c9" # Base 13 - Bright Yellow
set -l color12 "79/af/d2" # Base 16 - Bright Blue
set -l color13 "c4/a7/d8" # Base 17 - Bright Magenta
set -l color14 "8b/de/e0" # Base 15 - Bright Cyan
