...
set -l color00 "e0/e2/ea" # Base 00 - Black
set -l color01 "59/00/08" # Base 08 - Red
set -l color02 "00/55/23" # Base 0B - Green
set -l color03 "6b/53/00" # Base 0A - Yellow
set -l color04 "00/4c/73" # Base 0D - Blue
set -l color05 "47/00/45" # Base 0E - Magenta
set -l color06 "00/73/73" # Base 0C - Cyan
set -l color07 "14/16/1b" # Base 05 - White
set -l color08 "4f/52/58" # Base 03 - Bright Black
...
set -l color15 "07/08/0d" # Base 07 - Bright White
set -l color16 "8b/45/13" # Base 09
set -l color17 "a5/2a/2a" # Base 0F
set -l color18 "ee/f1/f8" # Base 01
set -l color19 "9b/9e/a4" # Base 02
set -l color20 "2c/2e/33" # Base 04
set -l color21 "07/08/0d" # Base 06
set -l color_foreground "14/16/1b" # Base 05
set -l color_background "e0/e2/ea" # Base 00
...
set -U fish_color_comment 4f5258
set -U fish_color_selection 07080d --background=9b9ea4
set -U fish_color_operator magenta
set -U fish_color_escape 8b4513
set -U fish_color_autosuggestion 4f5258
...
set -U fish_color_search_match yellow --background=9b9ea4
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress eef1f8 --background=2c2e33
set -U fish_pager_color_background --background=e0e2ea
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description 8b4513
set -U fish_pager_color_selected_background --background=9b9ea4
set -U fish_pager_color_selected_prefix --bold --italics --background=9b9ea4
...
# Set theme
set -Ux BASE16_THEME neovim-light

# Optionally export variables
if test -n "$TINTED_SHELL_ENABLE_BASE16_VARS"; or test -n "$BASE16_SHELL_ENABLE_VARS"
  set -gx BASE16_COLOR_00_HEX "e0e2ea"
  set -gx BASE16_COLOR_01_HEX "eef1f8"
  set -gx BASE16_COLOR_02_HEX "9b9ea4"
  set -gx BASE16_COLOR_03_HEX "4f5258"
  set -gx BASE16_COLOR_04_HEX "2c2e33"
  set -gx BASE16_COLOR_05_HEX "14161b"
  set -gx BASE16_COLOR_06_HEX "07080d"
  set -gx BASE16_COLOR_07_HEX "07080d"
  set -gx BASE16_COLOR_08_HEX "590008"
  set -gx BASE16_COLOR_09_HEX "8b4513"
  set -gx BASE16_COLOR_0A_HEX "6b5300"
  set -gx BASE16_COLOR_0B_HEX "005523"
  set -gx BASE16_COLOR_0C_HEX "007373"
  set -gx BASE16_COLOR_0D_HEX "004c73"
  set -gx BASE16_COLOR_0E_HEX "470045"
  set -gx BASE16_COLOR_0F_HEX "a52a2a"
end
