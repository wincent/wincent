...
set -U fish_color_selection 81506a --background=472234
set -U fish_color_operator magenta
set -U fish_color_escape ff9153
...
set -U fish_color_search_match yellow --background=472234
set -U fish_color_history_current --underline=curly
set -U fish_pager_color_progress 2f1823 --background=9b2a46
set -U fish_pager_color_background --background=131213
set -U fish_pager_color_prefix --bold --italics
set -U fish_pager_color_completion normal
set -U fish_pager_color_description ff9153
set -U fish_pager_color_selected_background --background=472234
set -U fish_pager_color_selected_prefix --bold --italics --background=472234
