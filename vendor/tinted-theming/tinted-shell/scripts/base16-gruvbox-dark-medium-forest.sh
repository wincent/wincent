...
export BASE16_THEME=gruvbox-dark-medium-forest
...
if [ -n "$TINTED_SHELL_ENABLE_BASE16_VARS" ] || [ -n "$BASE16_SHELL_ENABLE_VARS" ]; then
  ...
  export BASE16_COLOR_03_HEX="665c50"
  ...
  export BASE16_COLOR_0C_HEX="5f6c1f"
  export BASE16_COLOR_0D_HEX="b8bb26"
  export BASE16_COLOR_0E_HEX="96bda2"
