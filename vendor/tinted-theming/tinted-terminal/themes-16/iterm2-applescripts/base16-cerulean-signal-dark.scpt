...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 35466, 39578}
        set ANSI bright green color to {28784, 57825, 45232}
        set ANSI bright yellow color to {58082, 51400, 24415}
        set ANSI bright blue color to {32125, 54227, 65535}
        set ANSI bright magenta color to {65535, 29812, 54484}
        set ANSI bright cyan color to {22616, 55769, 57311}
