...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {7196, 2827, 10280}
        ...
        set ANSI white color to {48059, 45746, 44461}

        -- Set Bright ANSI Colors
        set ANSI bright black color to {21331, 19018, 24158}
        ...
        set ANSI bright white color to {61680, 59367, 54741}
    end tell
end tell
