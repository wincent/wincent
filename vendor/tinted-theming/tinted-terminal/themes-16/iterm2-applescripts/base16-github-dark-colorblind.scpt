...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI red color to {65021, 44204, 21588}
        ...
        set ANSI magenta color to {60652, 36494, 11308}
        ...
        set ANSI bright red color to {65021, 44204, 21588}
        ...
        set ANSI bright magenta color to {60652, 36494, 11308}
