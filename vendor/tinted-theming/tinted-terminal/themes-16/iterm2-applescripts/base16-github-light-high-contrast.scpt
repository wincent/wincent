...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {28784, 11308, 0}
        set ANSI bright green color to {771, 9509, 25443}
        set ANSI bright yellow color to {38293, 25700, 0}
        set ANSI bright blue color to {25186, 11308, 48316}
        set ANSI bright magenta color to {41120, 4369, 7967}
        set ANSI bright cyan color to {514, 19532, 6682}
