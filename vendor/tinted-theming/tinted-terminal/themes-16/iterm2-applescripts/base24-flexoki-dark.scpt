...
tell application "iTerm2"
    tell current session of current window
        ...
        -- Set ANSI Colors
        set ANSI black color to {7196, 6939, 6682}
        ...
        set ANSI white color to {59110, 58596, 55769}

        -- Set Bright ANSI Colors
        set ANSI bright black color to {10280, 10023, 9766}
        set ANSI bright red color to {44975, 12336, 10537}
        set ANSI bright green color to {44461, 33667, 257}
        set ANSI bright yellow color to {48316, 21074, 5397}
        set ANSI bright blue color to {9252, 33667, 31611}
        set ANSI bright magenta color to {8224, 24158, 42662}
        set ANSI bright cyan color to {26214, 32896, 2827}
