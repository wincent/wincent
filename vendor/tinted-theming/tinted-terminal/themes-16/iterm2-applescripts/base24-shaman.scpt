...
tell application "iTerm2"
    tell current session of current window
        set background color to {0, 4112, 5140}
        set foreground color to {15677, 20560, 21331}

        -- Set ANSI Colors
        set ANSI black color to {0, 4112, 5140}
        ...
        set ANSI white color to {15677, 20560, 21331}

        -- Set Bright ANSI Colors
        set ANSI bright black color to {14649, 18247, 20817}
