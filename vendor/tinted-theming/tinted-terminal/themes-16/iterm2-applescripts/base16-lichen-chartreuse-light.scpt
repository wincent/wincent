...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {12079, 29812, 25186}
        set ANSI bright yellow color to {20560, 27499, 10537}
        set ANSI bright blue color to {13621, 28270, 35466}
        set ANSI bright magenta color to {28270, 22102, 35209}
        set ANSI bright cyan color to {13621, 25957, 26985}
