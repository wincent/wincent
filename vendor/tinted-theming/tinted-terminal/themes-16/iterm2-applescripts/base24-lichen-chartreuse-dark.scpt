...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright green color to {53199, 58596, 44718}
        set ANSI bright yellow color to {54741, 44461, 29555}
        set ANSI bright blue color to {41891, 47288, 49858}
        set ANSI bright magenta color to {53970, 41120, 45746}
        set ANSI bright cyan color to {38807, 51657, 51657}
