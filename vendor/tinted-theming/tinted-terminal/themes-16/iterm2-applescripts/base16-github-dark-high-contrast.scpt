...
tell application "iTerm2"
    tell current session of current window
        ...
        set ANSI bright red color to {65535, 47031, 22359}
        set ANSI bright green color to {44461, 56540, 65535}
        set ANSI bright yellow color to {57568, 39835, 4883}
        set ANSI bright blue color to {56283, 47031, 65535}
        set ANSI bright magenta color to {65535, 38036, 37522}
        set ANSI bright cyan color to {29298, 61680, 34952}
