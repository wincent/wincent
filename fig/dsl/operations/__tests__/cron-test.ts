...
describe('validate()', () => {
  ...
  test('weekday names are valid', () => {
    ...
    expect(() => validate('minute', 'mon')).toThrow(/is not a valid minute/);
  ...
  test('month names are valid', () => {
    ...
    expect(() => validate('minute', 'jan')).toThrow(/is not a valid minute/);
    expect(() => validate('weekday', 'jan')).toThrow(/is not a valid weekday/);
  });
  ...
  test('out of range list items are invalid', () => {
    ...
    expect(() => validate('minute', '3,60')).toThrow(/is not a valid minute/);

    expect(() => validate('month', '0,3')).toThrow(/is not a valid month/);
    expect(() => validate('month', '3,13')).toThrow(/is not a valid month/);

    expect(() => validate('weekday', '3,8')).toThrow(/is not a valid weekday/);
  });
  ...
  test('bad month names are invalid', () => {
    expect(() => validate('month', 'garbage')).toThrow(/is not a valid month/);
  });
  ...
  test('"*/n" out of range is not valid', () => {
    ...
    expect(() => validate('minute', '*/0')).toThrow(/is not a valid minute/);
    expect(() => validate('month', '*/0')).toThrow(/is not a valid month/);
    expect(() => validate('weekday', '*/0')).toThrow(/is not a valid weekday/);

    expect(() => validate('day', '*/32')).toThrow(/is not a valid day/);
    expect(() => validate('hour', '*/24')).toThrow(/is not a valid hour/);
    expect(() => validate('minute', '*/60')).toThrow(/is not a valid minute/);
    expect(() => validate('month', '*/13')).toThrow(/is not a valid month/);
    expect(() => validate('weekday', '*/8')).toThrow(/is not a valid weekday/);
  });
